 ...
 *   1. Mock LLM server (Python, using Creanova-sdk TestLLM)
...
// mirroring docker/entrypoint.sh which uses $HOME/.Creanova/automation/automations.db.
...
export default defineConfig({
  ...
  webServer: [
    ...
    //
    // This mirrors the production `npx @Creanova/agent-canvas` path:
