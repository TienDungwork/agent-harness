...
const THOUGHT =
  "I'll create a webpage explaining what Creanova can do. " +
...
const reduce = (events: CreanovaEvent[]): CreanovaEvent[] =>
  events.reduce<CreanovaEvent[]>((ui, ev) => handleEventForUI(ev, ui), []);
