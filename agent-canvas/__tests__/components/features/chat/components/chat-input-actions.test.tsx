...
describe("ChatInputActions", () => {
  ...
  it("renders the AgentProfile picker inside a blank local Creanova conversation", () => {
  ...
  it("renders the LLM-profile switcher inside a started local Creanova conversation", () => {
    useActiveConversationMock.mockReturnValue({
  ...
  it("renders the LLM-profile switcher inside a cloud Creanova conversation", () => {
    // /switch_profile is a real endpoint on both backends (cloud proxies
    // POST /api/v1/app-conversations/{id}/switch_profile) — cloud Creanova
