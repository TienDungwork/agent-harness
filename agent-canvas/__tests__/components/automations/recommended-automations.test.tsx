...
} from "@Creanova/extensions/automations";
...
describe("recommended automations", () => {
  ...
  it("opens the Creanova Cloud integrations page without launching when the cloud option is chosen", () => {
    ...
    fireEvent.click(
      screen.getByTestId("responder-deployment-open-Creanova-cloud"),
    );
