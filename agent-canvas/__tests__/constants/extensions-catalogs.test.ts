...
import { AUTOMATION_CATALOG } from "@Creanova/extensions/automations";
import { INTEGRATION_CATALOG } from "@Creanova/extensions/integrations";
import {
...
describe("Creanova extensions catalogs", () => {
  it("hydrates the MCP marketplace from @Creanova/extensions", () => {
  ...
  it("loads recommended automations from @Creanova/extensions", () => {
