...
const EXTENSIONS_SKILLS_DIR = resolve(
  dirname(_require.resolve("@Creanova/extensions/package.json")),
  "skills",
);
...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    resolve: {
      ...
      alias: [
        {
          find: /^@Creanova\/typescript-client$/,
          replacement: resolve(
            process.cwd(),
            "node_modules/@Creanova/typescript-client/dist/index.js",
          ),
        },
        {
          find: /^@Creanova\/typescript-client\/(.*)$/,
          replacement: `${resolve(
            process.cwd(),
            "node_modules/@Creanova/typescript-client/dist",
          )}/$1`,
        },
      ],
    },
    ...
    optimizeDeps: {
      ...
      include: [
        ...
        "@Creanova/typescript-client",
        "@Creanova/typescript-client/client/http-client",
        "@Creanova/typescript-client/client/device-flow-client",
        "@Creanova/typescript-client/clients",
        "@Creanova/typescript-client/events/remote-events-list",
        "@Creanova/typescript-client/workspace/remote-workspace",
    ...
    test: {
      ...
      server: {
        deps: {
          inline: ["@Creanova/typescript-client"],
        },
      },
      coverage: {
