...
export const LOCKED_CLOUD_BACKEND_NAME = "Creanova Cloud";
 ...
 *
 * Used as the seed entry written to `Creanova-backends` on first load;
 * if it returns null, onboarding is responsible for collecting backend
 * connection details from the user.
 *
 * Returns null when the deployment is locked to a single Creanova Cloud
