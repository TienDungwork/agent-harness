/**
 * Minimal slice of the Creanova cloud organization shape that the GUI needs
 * to render the backend selector. Full shape lives in the Creanova repo;
...
/**
 * Subset of Creanova' OrganizationMember that the GUI reads. Returned by
