import { BashClient } from "@Creanova/typescript-client/clients";
import type { BashOutput } from "@Creanova/typescript-client";
...
// Providers absent here (Creanova, custom, unknown) report ``unknown``.
