import { PluginsClient } from "@Creanova/typescript-client/clients";
 ...
 * installed `@Creanova/typescript-client` package does not yet export these
 ...
 * local agent-server's `~/.Creanova/plugins/installed/`. A cloud backend has no
