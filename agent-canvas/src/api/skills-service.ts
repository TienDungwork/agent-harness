import { SkillsClient } from "@Creanova/typescript-client/clients";
import {
  SKILLS_CATALOG,
  type SkillCatalogEntry,
} from "@Creanova/extensions/skills";
...
/**
 * Public skills loaded from the `@Creanova/extensions` npm package.
 *
 ...
 * runtime. Updating the catalog requires bumping the `@Creanova/extensions`
...
class SkillsService {
  static async getSkills(projectDir?: string): Promise<SkillInfo[]> {
    ...
    // Public skills come from the bundled @Creanova/extensions npm package —
