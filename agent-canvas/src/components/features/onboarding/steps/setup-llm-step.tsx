...
/**
 * Pre-fills the LLM form with the same default as {@link DEFAULT_SETTINGS}
 * so onboarding, settings UI, and persisted agent_settings stay aligned.
 * Keeping this as an explicit override marks the model dirty so the Next
 * button persists the suggested default immediately.
 */
export const ONBOARDING_DEFAULT_LLM_MODEL = DEFAULT_SETTINGS.llm_model;
 ...
 * who get the Creanova default from {@link DEFAULT_SETTINGS} pre-filled,
 * including the self-hosted LiteLLM Base URL when configured.
 */
