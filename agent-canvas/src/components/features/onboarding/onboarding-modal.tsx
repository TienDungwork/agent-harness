 ...
 */
const ONBOARDING_STARTED_TRACKED_KEY = "Creanova-onboarding-started";
...
export function OnboardingModal({
  ...
  const [selectedAgentId, setSelectedAgentId] =
    React.useState<OnboardingAgentId>("Creanova");
  ...
  const isCreanova = selectedAgentId === "Creanova";
  ...
  return (
    ...
    // Escape press — see https://github.com/Creanova/agent-canvas/issues/1085.
