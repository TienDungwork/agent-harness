 ...
 *
 * Shows a "Login with Creanova Cloud" button that initiates OAuth 2.0 Device Flow
...
export function DeviceFlowAuth({
  ...
  const idleLabel = idleButtonLabel ?? t(I18nKey.BACKEND$LOGIN_WITH_Creanova);
    ...
    >
      ...
      {showStatusModal ? (
        <ModalBackdrop
          ...
          aria-label={t(I18nKey.BACKEND$LOGIN_WITH_Creanova)}
