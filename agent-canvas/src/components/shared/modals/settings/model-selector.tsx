...
export function ModelSelector({
  ...
  // Cloud-only signup CTA. Local / self-hosted installs bring their own
  // keys and must not be pushed to the SaaS account page.
  const showCreanovaAccountHelp =
    selectedProvider === "Creanova" &&
    !isNoBackend(backend) &&
    backend.kind === "cloud";
  ...
  return (
    ...
    >
      ...
      {showCreanovaAccountHelp && (
        <HelpLink
          testId="Creanova-account-help"
          text={t(I18nKey.SETTINGS$NEED_Creanova_ACCOUNT)}
