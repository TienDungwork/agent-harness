import { AppWindow, Server, Shield } from "lucide-react";
...
export interface SettingsNavItem {
  ...
  // manages its own LLM / condenser / MCP, so these Creanova-side
...
export const OSS_NAV_ITEMS: SettingsNavItem[] = [
  ...
  },
  {
    ...
    to: "/settings/host",
    text: "SETTINGS$NAV_HOST",
    subtitle: "SETTINGS$PAGE_HOST_SUBLINE",
  },
];
