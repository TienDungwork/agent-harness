import type { MessageEvent, CreanovaEvent } from "#/types/agent-server/core";
...
export const TABLE_DEMO_AGENT_MARKDOWN = [
  ...
  "",
  "| Feature | Creanova | Claude Code | Codex | Gemini CLI | Cursor | Windsurf | Cline | Aider | Devin | Continue |",
  "| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |",
...
export const TABLE_DEMO_EVENTS: CreanovaEvent[] = [
