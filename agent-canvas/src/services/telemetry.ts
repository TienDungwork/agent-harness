 ...
 *
 * This module handles anonymous telemetry for the @Creanova/agent-canvas package
 ...
 *
 * AD BLOCKER BYPASS:
 * By default, telemetry is routed through Creanova' reverse proxy (z.Creanova.dev)
 ...
 *
 * IMPORTANT: By default, telemetry is sent to the Creanova PostHog project.
...
const TELEMETRY_CONSENT_KEY = "Creanova-telemetry-consent";
const TELEMETRY_CONSENT_PENDING_CLOUD_SYNC_KEY =
  "Creanova-telemetry-consent-pending-cloud-sync";
const TELEMETRY_CONSENT_CHANGE_EVENT = "Creanova-telemetry-consent-change";
const TELEMETRY_FIRST_USE_KEY = "Creanova-telemetry-first-use";
const TELEMETRY_SESSION_KEY = "Creanova-telemetry-session";
...
// Default to Creanova' reverse proxy to bypass ad blockers.
// The proxy at z.Creanova.dev routes to PostHog's US region.
// Library consumers can override this with their own proxy or direct PostHog URL.
const DEFAULT_POSTHOG_HOST =
  import.meta.env.VITE_POSTHOG_HOST || "https://z.Creanova.dev";
