import type { RecommendedAutomation } from "@Creanova/extensions/automations";
import { I18nKey } from "#/i18n/declaration";
import { PRODUCT_URL } from "#/utils/constants";

/** Creanova Cloud integrations page — where always-on responders are set up. */
export const Creanova_CLOUD_INTEGRATIONS_URL = `${PRODUCT_URL.PRODUCTION}/settings/integrations`;
...
/**
 * Where a responder runs. Only `local` and `Creanova-cloud` are wired today;
