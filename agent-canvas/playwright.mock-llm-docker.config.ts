 ...
 *   1. Mock LLM server (Python on the host, using Creanova-sdk TestLLM)
 ...
 *     (default: ghcr.io/Creanova/agent-canvas:latest).
...
// ── Docker image ────────────────────────────────────────────────────────
const DOCKER_IMAGE =
  process.env.MOCK_LLM_DOCKER_IMAGE ?? "ghcr.io/Creanova/agent-canvas:latest";
...
// the agent-server's expected ~/.Creanova/skills/ path.
const USER_SKILLS_HOST_DIR = resolve(".tmp/mock-llm-user-skills");
const USER_SKILLS_CONTAINER_DIR = "/home/Creanova/.Creanova/skills";
...
// The agent-server image ships Python 3 via the Creanova-sdk base.
