...
| Feature | Creanova | Claude Code | Codex | Gemini CLI |
|---|:---:|:---:|:---:|:---:|
| Onboarding | ☐ | ☐ | ☐ | ☐ |
...
| `test:e2e:mock-llm` | npm | Linux | Creanova, ACP (mock) | ✅ full |
| `test:e2e:mock-llm:docker` | Docker | Linux | Creanova, ACP (mock) | ✅ full |
| `test:e2e:live` | npm | Linux | Creanova | ❌ |
