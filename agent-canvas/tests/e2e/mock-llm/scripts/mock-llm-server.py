"""Mock OpenAI-compatible LLM server powered by Creanova-sdk TestLLM.
...
os.environ["Creanova_SUPPRESS_BANNER"] = "1"
...
from Creanova.sdk.testing import TestLLM, TestLLMExhaustedError
