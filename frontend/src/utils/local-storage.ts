...
export const LOCAL_STORAGE_KEYS = {
  LOGIN_METHOD: "Creanova_login_method",
  ENTERPRISE_FORM_SAAS: "Creanova_enterprise_form_saas",
  ENTERPRISE_FORM_SELF_HOSTED: "Creanova_enterprise_form_self_hosted",
  SELECTED_ORG: "Creanova_selected_org",
};
