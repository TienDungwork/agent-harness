...
class V1ConversationService {
  ...
  static async sendMessage(
    ...
    const { data } = await Creanova.post<V1SendMessageResponse>(
  ...
  static async createConversation(
    ...
    const { data } = await Creanova.post<V1AppConversationStartTask>(
  ...
  static async getStartTask(
    ...
    const { data } = await Creanova.get<(V1AppConversationStartTask | null)[]>(
  ...
  static async searchStartTasks(
    ...
    const { data } = await Creanova.get<V1AppConversationStartTaskPage>(
  ...
  static async batchGetAppConversations(
    ...
    const { data } = await Creanova.get<(V1AppConversation | null)[]>(
  ...
  static async getConversationConfig(
    ...
    const { data } = await Creanova.get<{ runtime_id: string }>(url);
    return data;
  }
  ...
  static async updateConversationPublicFlag(
    ...
    const { data } = await Creanova.patch<V1AppConversation>(
  ...
  static async downloadConversation(conversationId: string): Promise<Blob> {
    const response = await Creanova.get(
  ...
  static async getSkills(conversationId: string): Promise<GetSkillsResponse> {
    const { data } = await Creanova.get<GetSkillsResponse>(
  ...
  static async getHooks(conversationId: string): Promise<GetHooksResponse> {
    const { data } = await Creanova.get<GetHooksResponse>(
  ...
  static async searchConversationsBySandboxId(
    ...
    const { data } = await Creanova.get<V1AppConversationPage>(
  ...
  static async deleteConversation(conversationId: string): Promise<void> {
    await Creanova.delete(`/api/v1/app-conversations/${conversationId}`);
  }
