...
export const integrationService = {
  ...
  getGitLabResources: async (): Promise<GitLabResourcesResponse> => {
    const { data } = await Creanova.get<GitLabResourcesResponse>(
  ...
  reinstallGitLabWebhook: async ({
    ...
    const { data } = await Creanova.post<ResourceInstallationResult>(
  ...
  getBitbucketDCResources: async (): Promise<BitbucketDCResourcesResponse> => {
    const { data } = await Creanova.get<BitbucketDCResourcesResponse>(
  ...
  /**
   * Enroll a Bitbucket Data Center repository webhook in Creanova.
  ...
  enrollBitbucketDCWebhook: async ({
    ...
    const { data } = await Creanova.post<BitbucketDCWebhookEnrollmentResult>(
  ...
  updateBitbucketDCWebhookId: async ({
    ...
    const { data } = await Creanova.patch<BitbucketDCWebhookIdUpdateResult>(
  ...
  reinstallBitbucketDCWebhook: async ({
    ...
    const { data } = await Creanova.post<BitbucketDCWebhookInstallationResult>(
  ...
  getAzureDevOpsResources: async (): Promise<AzureDevOpsWebhookStatus> => {
    const { data } = await Creanova.get<AzureDevOpsWebhookStatus>(
  ...
  reinstallAzureDevOpsWebhook:
    async (): Promise<AzureDevOpsWebhookInstallationResult> => {
      const { data } =
        await Creanova.post<AzureDevOpsWebhookInstallationResult>(
