...
import type { CreanovaParsedEvent } from "#/types/core";
import { isObservationEvent } from "#/types/v1/type-guards";
import type { CreanovaEvent } from "#/types/v1/core";
...
function getTaskListFromEvent(event: OHEvent): TaskListItem[] | null {
  ...
  const v0 = event as CreanovaParsedEvent;
  ...
  const v1 = event as CreanovaEvent;
  if (
