...
interface ConversationSubscriptionsContextType {
  ...
  getEventsForConversation: (conversationId: string) => CreanovaParsedEvent[];
}
...
const isAgentStatusError = (event: unknown): event is CreanovaParsedEvent =>
  isCreanovaEvent(event) &&
