...
import { CreanovaEvent, ObservationEvent, ActionEvent } from "#/types/v1/core";
import {
  isActionEvent,
  isObservationEvent,
  isACPToolCallEvent,
...
const getActionEventTitle = (event: CreanovaEvent): React.ReactNode => {
...
export const getEventContent = (
  event: CreanovaEvent | SkillReadyEvent,
  correspondingAction?: ActionEvent,
) => {
