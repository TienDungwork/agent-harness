    ...
    <ModalBackdrop onClose={handleClose}>
      <ModalBody className="items-start border border-tertiary w-96">
          ...
          {showConfigurationFields ? (
            <Trans
              ...
              components={{
                ...
                a: (
                  <a
                    href="https://docs.all-hands.dev/usage/cloud/Creanova-cloud"
                    target="_blank"
        ...
        <div className="w-full flex flex-col gap-4 mt-1">
          ...
          {showConfigurationFields && (
            <>
              {/* Webhook (Jira -> Creanova). Jira DC: auto-install via a
              ...
              {/* Service account (Creanova -> Jira): used to post comments and
