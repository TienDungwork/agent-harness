...
describe("getGitPath", () => {
  ...
  describe("without sandbox grouping (NO_GROUPING)", () => {
    ...
    it("should handle standard owner/repo format (GitHub)", () => {
      expect(getGitPath(conversationId, "Creanova/Creanova", false)).toBe(
        "/workspace/project/Creanova",
      );
  ...
  describe("with sandbox grouping enabled", () => {
    ...
    it("should handle standard owner/repo format (GitHub)", () => {
      expect(getGitPath(conversationId, "Creanova/Creanova", true)).toBe(
        `/workspace/project/${conversationId}/Creanova`,
      );
