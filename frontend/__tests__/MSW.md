...
> [!NOTE]
> **Creanova vs SaaS Mode**
>
> Creanova runs in two modes:
> - **Creanova mode**: For local/self-hosted deployments where users provide their own LLM API keys and configure git providers manually
