    ...
    useTranslation: () => ({
      t: (key: string) => {
        const translations: Record<string, string> = {
          "CTA$ENTERPRISE_TITLE": "Get Creanova for Enterprise",
          "CTA$ENTERPRISE_DESCRIPTION":
            "Cloud allows you to access Creanova anywhere and coordinate with your team like never before",
...
describe("HomepageCTA", () => {
  ...
  describe("rendering", () => {
    it("renders the enterprise title", () => {
      renderHomepageCTA();
      expect(
        screen.getByText("Get Creanova for Enterprise"),
      ).toBeInTheDocument();
    });
    ...
    it("renders the enterprise description", () => {
      renderHomepageCTA();
      expect(
        screen.getByText(/Cloud allows you to access Creanova anywhere/),
      ).toBeInTheDocument();
    });
