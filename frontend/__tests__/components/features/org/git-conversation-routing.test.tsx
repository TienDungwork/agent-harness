...
describe("GitConversationRouting", () => {
  ...
  it("should render organizations from API data", () => {
    ...
    expect(screen.getByTestId("org-row-github:Creanova")).toHaveTextContent(
      "GitHub/Creanova",
    );
  ...
  it("should show claimed org with 'Claimed' label", () => {
    ...
    const claimedButton = screen.getByTestId("claim-button-github:Creanova");
  ...
  it("should call disconnect mutation when clicking disconnect on claimed org", async () => {
    ...
    await user.click(screen.getByTestId("claim-button-github:Creanova"));
