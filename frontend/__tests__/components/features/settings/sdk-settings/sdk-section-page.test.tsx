...
describe("SdkSectionPage", () => {
          ...
          fields: [
            {
              ...
              section_label: "LLM",
              value_type: "string",
              default: "Creanova/claude-opus-4-5-20251101",
              choices: [],
              depends_on: [],
              prominence: "critical",
              secret: false,
  ...
  it("drops duplicate union sections that don't match the source variant", async () => {
    ...
    // both the "Creanova" and "acp" variants (#14892). A variant-targeted
    ...
    // Creanova fields render exactly once; the acp duplicate is dropped.
