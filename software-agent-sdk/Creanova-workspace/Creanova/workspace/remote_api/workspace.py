...
class APIRemoteWorkspace(RemoteWorkspace):
    """Remote workspace using Creanova runtime API.
    ...
    Example:
        workspace = APIRemoteWorkspace(
            ...
            server_image="ghcr.io/Creanova/agent-server:lastest-python",
        )
    """  # noqa: E501
    ...
    def _start_runtime(self) -> None:
        ...
        if self.target_type == "binary":
            executable = "/usr/local/bin/Creanova-agent-server"
        else:
            executable = "/agent-server/.venv/bin/python -m Creanova.agent_server"
