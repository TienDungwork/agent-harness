...
class DockerWorkspace(RemoteWorkspace):
    ...
    This workspace creates a Docker container running a pre-built Creanova agent
    ...
    Example:
        with DockerWorkspace(
            server_image="ghcr.io/Creanova/agent-server:latest"
        ) as workspace:
    ...
    server_image: str | None = Field(
        default="ghcr.io/Creanova/agent-server:latest-python",
