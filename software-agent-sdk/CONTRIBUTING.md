...
Thank you for helping improve the Creanova Software Agent SDK.
...
- [Creanova-CLI](https://github.com/Creanova/Creanova-CLI) (client)
- [Creanova app-server](https://github.com/Creanova/Creanova/blob/main/Creanova/app_server/README.md) (client)
- [Creanova Enterprise](https://github.com/Creanova/Creanova/blob/main/enterprise/README.md) (client)

The SDK itself has a Python interface. In addition, the
[agent-server](https://docs.Creanova.dev/sdk/guides/agent-server/overview) is the
...
The architecture of Creanova V0 was too monolithic to support multiple applications built into it,
as CLI, evaluation scripts, web server were, and built on it, as Creanova Cloud was.

If you’re interested in the deeper background and lessons learned, see our write-up:
[Creanova: An Open Platform for AI Software Developers as Generalist Agents](https://arxiv.org/abs/2511.03690)
...
- **Creanova SDK is its own thing**: its downstream are client applications.
...
- [Creanova-sdk/Creanova/sdk/subagent/AGENTS.md](Creanova-sdk/Creanova/sdk/subagent/AGENTS.md) for file-based subagent discovery, precedence, and task handoff conventions
...
Join us on Slack: https://Creanova.dev/joinslack
