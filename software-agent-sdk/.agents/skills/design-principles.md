...
description: Core architectural design principles of the Creanova Software Agent SDK. Reference when making architectural decisions, reviewing PRs that change agent/tool/state boundaries, or evaluating whether a proposed change aligns with V1 design goals.
---

# SDK Design Principles

Reference: <https://docs.Creanova.dev/sdk/arch/design>
