#!/usr/bin/env python3
"""Trigger, compare, and report on Creanova evaluation runs.
...
DASHBOARD_BASE = "https://Creanova-eval-monitor.vercel.app"

SDK_REPO = "Creanova/software-agent-sdk"
BENCHMARKS = [
    "swebench",
    "swebenchpro",
    "gaia",
...
def cmd_compare(args: argparse.Namespace) -> None:
    ...
    if args.post_comment:
        ...
        body = (
            ...
            + "(Creanova) on behalf of the user.*\n"
        )
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Trigger, compare, and report on Creanova evaluation runs",
    )
