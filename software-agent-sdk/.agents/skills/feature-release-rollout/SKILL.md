...
This skill guides the complete feature release workflow across the Creanova ecosystem repositories.

## Overview

When a feature is implemented in the SDK, it may need propagation through several repositories:

1. **SDK** (`Creanova/software-agent-sdk`) — Core feature implementation
2. **CLI** (`Creanova/Creanova-CLI`) — Terminal interface support
3. **GUI** (`Creanova/Creanova` frontend directory) — Web interface support
4. **Docs** (`Creanova/docs`) — Documentation updates (sdk/ folder)
5. **Blog** (`Creanova/growth-utils` blog-post/) — Marketing and announcements
...
git clone https://github.com/Creanova/software-agent-sdk.git
...
git clone https://github.com/Creanova/software-agent-sdk.git
git clone https://github.com/Creanova/Creanova-CLI.git
git clone https://github.com/Creanova/Creanova.git        # Frontend in frontend/
git clone https://github.com/Creanova/docs.git
git clone https://github.com/Creanova/growth-utils.git
```
...
|------------|---------------|------------------|
| CLI | `Creanova_cli/` | Feature flags, commands, TUI widgets |
| GUI | `Creanova/frontend/src/` | React components, API integrations |
...
gh issue create --repo Creanova/Creanova-CLI \
...
### CLI (Creanova/Creanova-CLI)

- Check `AGENTS.md` for development guidelines
- Use `uv` for dependency management
- Run `make lint` and `make test` before commits
- TUI components in `Creanova_cli/tui/`
- Snapshot tests for UI changes

### GUI (Creanova/Creanova frontend)
...
- Follow `Creanova/DOC_STYLE_GUIDE.md`

### Blog (Creanova/growth-utils)
...
1. **SDK**: ✅ Implemented in `Creanova.tools.browser`
...
grep -r "feature_name" software-agent-sdk/Creanova/ --include="*.py"

# Check CLI support
grep -r "feature_name" Creanova-CLI/Creanova_cli/ --include="*.py"

# Check GUI support
grep -r "featureName" Creanova/frontend/src/ --include="*.ts" --include="*.tsx"
