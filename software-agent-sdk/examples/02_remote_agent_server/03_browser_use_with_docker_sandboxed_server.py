...
from Creanova.sdk import LLM, Conversation, get_logger
...
def get_server_image():
    ...
    if sha:
        return f"ghcr.io/Creanova/agent-server:{sha[:7]}-python-{arch}"
    return "ghcr.io/Creanova/agent-server:latest-python"
...
with DockerWorkspace(
    ...
    conversation.send_message(
        "Could you go to https://Creanova.dev/ blog page and summarize main "
    ...
    if os.getenv("CI"):
        ...
        while y != "y":
            y = input(
                ...
                "you can open a browser tab to see the *actual* browser Creanova "
