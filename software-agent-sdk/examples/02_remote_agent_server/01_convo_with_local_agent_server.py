...
from Creanova.sdk import LLM, Conversation, RemoteConversation, Workspace, get_logger
from Creanova.sdk.event import ConversationStateUpdateEvent, HookExecutionEvent
...
title_gen_llm = LLM(
    ...
    model=os.getenv("LLM_MODEL", "Creanova/gpt-5-mini-2025-08-07"),
    base_url=os.getenv("LLM_BASE_URL"),
    api_key=SecretStr(api_key),
)
