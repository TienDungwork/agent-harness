...
inside a local ``Creanova.agent_server`` subprocess, tool specs are sent in
...
from Creanova.sdk import LLM, Conversation, Event, RemoteConversation, get_logger
...
with ManagedAPIServer(port=8004) as server:
    ...
    from Creanova.sdk import Workspace
