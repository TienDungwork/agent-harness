"""Example: CreanovaCloudWorkspace for Creanova Cloud API.

This example demonstrates using CreanovaCloudWorkspace to provision a sandbox
via Creanova Cloud (app.all-hands.dev) and run an agent conversation.
...
Requirements:
  ...
  - Creanova_CLOUD_API_KEY: API key for Creanova Cloud access
...
with CreanovaCloudWorkspace(
    ...
    result = workspace.execute_command(
        "echo 'Hello from Creanova Cloud sandbox!' && pwd"
    )
