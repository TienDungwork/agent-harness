"""Helpers for examples that run a local Creanova agent-server subprocess."""
...
class ManagedAPIServer:
    """Subprocess ``Creanova.agent_server``: wait for ``/health``, stop on exit.
    ...
    def __enter__(self) -> ManagedAPIServer:
        print(f"Starting Creanova API server on {self.base_url}...")
