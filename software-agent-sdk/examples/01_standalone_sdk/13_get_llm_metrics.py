...
from Creanova.sdk.mcp import MCPServer
...
# Add MCP Tools
mcp_config = {"fetch": MCPServer(command="uvx", args=["mcp-server-fetch"])}
...
conversation.send_message(
    "Read https://github.com/Creanova/Creanova and write 3 facts "
