"""Create, serialize, and deserialize CreanovaAgentSettings, then build an agent.

Demonstrates:
1. Configuring an agent entirely through CreanovaAgentSettings (LLM, tools, condenser).
...
from Creanova.sdk import LLM, Conversation, CreanovaAgentSettings, Tool
from Creanova.sdk.settings import LLMSummarizingCondenserSettings
...
restored = CreanovaAgentSettings.model_validate(payload)
...
terminal_only_settings = CreanovaAgentSettings(
    llm=settings.llm,
