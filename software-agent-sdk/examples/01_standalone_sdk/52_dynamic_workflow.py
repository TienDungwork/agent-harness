...
from Creanova.sdk import LLM, Agent, AgentContext, Conversation, Tool
from Creanova.sdk.context import Skill
from Creanova.sdk.subagent import register_agent_if_absent
from Creanova.tools.delegate import DelegationVisualizer
from Creanova.tools.file_editor import FileEditorTool
from Creanova.tools.terminal import TerminalTool
from Creanova.tools.workflow import WorkflowToolSet
...
conversation.send_message(
    ...
    "one item for each project area: `Creanova-sdk/Creanova/sdk`, "
    "`Creanova-tools/Creanova/tools`, "
    "`Creanova-workspace/Creanova/workspace`, and "
    "`Creanova-agent-server/Creanova/agent_server`. Use `wf.map_agents` "
