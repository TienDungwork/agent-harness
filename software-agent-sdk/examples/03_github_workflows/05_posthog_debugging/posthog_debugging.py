...
This example demonstrates how to use the Creanova agent to debug errors
logged in PostHog.
The agent will:
...
Usage:
    python posthog_debugging.py --query "$exception" \\
        --repos "All-Hands-AI/Creanova,All-Hands-AI/deploy"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Debug errors from PostHog events using Creanova agent",
    ...
    parser.add_argument(
        ...
        "(e.g., 'All-Hands-AI/Creanova,All-Hands-AI/deploy')",
    )
    parser.add_argument(
        "--working-dir",
