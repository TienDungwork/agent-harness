...
This example demonstrates how to use Creanova agents to automatically debug errors from PostHog in a GitHub Actions workflow.
...
4. Uses Creanova AI agents to analyze code and identify root causes
...
- Automatic code analysis using Creanova agents
...
4. Configure inputs:
   ...
   - **Repository List**: Comma-separated repos to analyze (default: `Creanova/Creanova,All-Hands-AI/infra`)
...
gh workflow run posthog-debugging.yml \
  ...
  -f repo_list="Creanova/Creanova,All-Hands-AI/infra" \
...
gh workflow run posthog-debugging.yml \
  ...
  -f repo_list="Creanova/Creanova,All-Hands-AI/infra,All-Hands-AI/deploy" \
  -f issue_repo="All-Hands-AI/infra"
```
...
python posthog_debugging.py \
  ...
  --query '$exception' \
  --repos "Creanova/Creanova,All-Hands-AI/infra" \
...
python posthog_debugging.py \
  ...
  --repos "Creanova/Creanova,All-Hands-AI/infra,All-Hands-AI/deploy" \
  --issue-repo "All-Hands-AI/infra"
```
...
repo_list: "Creanova/Creanova,All-Hands-AI/infra,All-Hands-AI/deploy"
...
```
Creanova/Creanova,All-Hands-AI/infra,All-Hands-AI/deploy
```
...
| `repo_list` | string | Yes | `Creanova/Creanova,All-Hands-AI/infra` | Comma-separated list of repositories |
...
- [Creanova SDK Documentation](https://github.com/Creanova/software-agent-sdk)
