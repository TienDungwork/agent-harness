...
This example demonstrates how to set up a GitHub Actions workflow for automated routine maintenance tasks using the Creanova agent SDK.

## Files

- **`workflow.yml`**: GitHub Actions workflow file that can be copied to `.github/workflows/` in your repository
- **`agent_script.py`**: Python script that runs the Creanova agent with a custom prompt
...
Your custom script should accept a prompt location as a command-line argument and use the Creanova SDK to run the agent.
...
- [Creanova SDK Documentation](https://docs.all-hands.dev/)
- [GitHub Actions Documentation](https://docs.github.com/en/actions)
- [LLM Provider Setup](https://docs.all-hands.dev/Creanova/usage/llms/Creanova-llms)
