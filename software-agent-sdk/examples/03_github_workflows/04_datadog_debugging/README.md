...
This example demonstrates how to use Creanova agents to automatically debug errors from Datadog in a GitHub Actions workflow.
...
- `Creanova/claude-haiku-4-5-20251001` - Faster, cheaper
