...
from Creanova.sdk.hooks.config import HookDefinition, HookType
from Creanova.sdk.hooks.executor import HookExecutor
...
class TestHookExecutor:
    ...
    def test_execute_environment_variables(self, executor, sample_event, tmp_path):
        ...
        hook = HookDefinition(
            command=python_command(
                "import os; "
                "print(f\"SESSION={os.environ['Creanova_SESSION_ID']}\"); "
                "print(f\"TOOL={os.environ['Creanova_TOOL_NAME']}\")"
            )
        )
...
class TestAsyncHookExecution:
    ...
    def test_execute_async_hook_uses_windows_process_group(
        ...
        import Creanova.sdk.hooks.executor as executor_module
...
class TestAsyncProcessManager:
    ...
    def test_add_process_and_cleanup_all(self, tmp_path):
        ...
        from Creanova.sdk.hooks.executor import AsyncProcessManager
...
class TestAgentHookExecution:
    ...
    _AGENT_PATH = "Creanova.sdk.agent.Agent"
    _CONV_PATH = "Creanova.sdk.conversation.impl.local_conversation.LocalConversation"
    _RESPONSE_PATH = (
        "Creanova.sdk.conversation.response_utils.get_agent_final_response"
    )
    ...
    def test_execute_dispatches_to_agent_hook(self, executor, sample_event):
        ...
        from Creanova.sdk.hooks.executor import HookResult
    ...
    def test_parent_visualizer_instance_is_not_rebound(self, tmp_path, mock_llm):
        ...
        """
        from Creanova.sdk.conversation.visualizer import ConversationVisualizerBase
