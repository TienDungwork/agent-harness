...
def test_model_canonical_name_used_for_capabilities(monkeypatch):
    ...
    monkeypatch.setattr(
        "Creanova.sdk.llm.llm.get_litellm_model_info", fake_get_model_info
    )
    monkeypatch.setattr("Creanova.sdk.llm.llm.supports_vision", fake_supports_vision)
    monkeypatch.setattr("Creanova.sdk.llm.llm.get_features", fake_get_features)
