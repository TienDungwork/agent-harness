...
from Creanova.sdk.llm.message import Message, ReasoningItemModel, TextContent
...
@patch("Creanova.sdk.llm.llm.litellm_responses")
...
@pytest.mark.asyncio
@patch("Creanova.sdk.llm.llm.litellm_aresponses", new_callable=AsyncMock)
