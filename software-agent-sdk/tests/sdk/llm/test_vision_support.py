...
from Creanova.sdk.llm import LLM, ImageContent, Message, TextContent
...
@patch(
    "Creanova.sdk.llm.llm.get_litellm_model_info",
    return_value={"supports_vision": False},
)
@patch("Creanova.sdk.llm.llm.supports_vision", return_value=False)
