...
from Creanova.sdk.event import Condensation, MessageEvent
from Creanova.sdk.llm import LLM, LLMResponse, Message, TextContent
from Creanova.sdk.tool import Action, Observation, ToolDefinition
...
@patch("Creanova.sdk.event.base.LLMConvertibleEvent.events_to_messages")
