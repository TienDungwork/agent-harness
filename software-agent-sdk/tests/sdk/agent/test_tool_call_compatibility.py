...
from Creanova.sdk.agent import Agent, utils as agent_utils
from Creanova.sdk.conversation import Conversation, LocalConversation
from Creanova.sdk.event import ActionEvent, AgentErrorEvent, ObservationEvent
from Creanova.sdk.llm import LLM, Message, TextContent
from Creanova.sdk.tool import Action, Observation, Tool, ToolExecutor, register_tool
...
def _run_tool_call(
    ...
    *,
    ...
    with patch(
        "Creanova.sdk.llm.llm.litellm_completion",
...
def test_explicitly_registered_tool_not_hijacked_by_alias():
    ...
    """
    from Creanova.sdk.agent.utils import normalize_tool_call
