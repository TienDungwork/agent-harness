...
from Creanova.sdk.git.cached_repo import (
    GitHelper,
    _checkout_ref,
    _clone_repository,
    _update_repository,
)
from Creanova.sdk.git.exceptions import GitCommandError
...
def test_git_clone_timeout(tmp_path: Path):
    ...
    with patch("Creanova.sdk.git.utils.subprocess.run") as mock_run:
