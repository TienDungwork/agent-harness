...
def _reset_observability_cache():
    ...
    """
    from Creanova.sdk.observability import laminar
...
def test_lmnr_base_url_parsing(env_value, expected):
    ...
    try:
        ...
        from Creanova.sdk.observability.laminar import get_env
        ...
        with patch("lmnr.Laminar") as mock_laminar:
            with patch("lmnr.LaminarLiteLLMCallback"):
                with patch("litellm.callbacks", new=MagicMock()):
                    ...
                    from Creanova.sdk.observability.laminar import maybe_init_laminar
...
def test_get_bool_env(env_value, expected):
    ...
    try:
        ...
        from Creanova.sdk.observability.laminar import _get_bool_env
...
class _DummyOwner:
    ...
    def __init__(self, root_span):
        from Creanova.sdk.observability.laminar import RootSpan
...
def test_observe_calls_use_span_with_owner_root_span_on_sync():
    ...
    try:
        ...
        from Creanova.sdk.observability import laminar as lam
...
def test_two_concurrent_conversations_do_not_collide():
    ...
    from Creanova.sdk.conversation import base as base_mod
...
def test_root_span_sets_trace_metadata_and_tags():
    ...
    with patch("lmnr.Laminar") as mock_laminar:
        ...
        RootSpan(
            ...
            metadata={"repo_name": "Creanova/software-agent-sdk"},
            tags=["repo:Creanova/software-agent-sdk"],
        )
        ...
        mock_laminar.set_span_tags.assert_called_once_with(
            ["repo:Creanova/software-agent-sdk"]
        )
