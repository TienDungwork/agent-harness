...
from Creanova.sdk.event.condenser import Condensation, CondensationRequest
...
def mock_llm() -> LLM:
    ...
    mock_llm.openrouter_app_name = "Creanova"
...
def test_default_values(mock_llm: LLM) -> None:
    ...
    See https://github.com/Creanova/software-agent-sdk/issues/1518 for context.
    """
...
def test_condense_with_hard_requirement_and_no_condensation_available(
    ...
    """
    from Creanova.sdk.context.condenser.base import NoCondensationAvailableException
...
@patch("Creanova.sdk.llm.llm.LLM._transport_call", autospec=True)
...
@pytest.mark.asyncio
@patch("Creanova.sdk.llm.llm.LLM._atransport_call", new_callable=AsyncMock)
