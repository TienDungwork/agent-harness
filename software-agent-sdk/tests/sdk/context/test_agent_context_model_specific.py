...
from Creanova.sdk.skills import load_project_skills
...
def _write_repo_with_vendor_files(root: Path, baseline_source: str) -> None:
    ...
    Args:
        ...
        baseline_source: Either "repo_md" (legacy .Creanova/skills/repo.md)
...
# - "repo_md": Legacy .Creanova/skills/repo.md (still supported for existing repos)
