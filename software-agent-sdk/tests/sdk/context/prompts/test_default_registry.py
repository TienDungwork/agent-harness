...
from Creanova.sdk.context.prompts.sections.dynamic import (
...
from Creanova.sdk.context.prompts.sections.static import (
    BrowserSection,
    EfficiencySection,
...
from Creanova.sdk.skills import KeywordTrigger, Skill
...
def test_soul_section_renders_custom_and_defaults() -> None:
    ...
    assert default == (
        "<SOUL>\nYou are Creanova agent, a helpful AI assistant that can"
