...
from Creanova.sdk.skills.skill import PUBLIC_SKILLS_REF
...
def test_pinned_cache_entry_never_expires():
    ...
    cache_key = ("https://github.com/Creanova/extensions", "v1.0.0", None)
    ...
    with patch("Creanova.sdk.skills.skill.update_skills_repository") as mock_update:
...
def test_mutable_cache_entry_expires_after_ttl():
    ...
    cache_key = ("https://github.com/Creanova/extensions", "main", None)
