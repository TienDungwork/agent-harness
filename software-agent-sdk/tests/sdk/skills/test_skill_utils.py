...
from Creanova.sdk.context import (
    KeywordTrigger,
    Skill,
...
def test_legacy_micro_agent_load(tmp_path):
    ...
    legacy_file = tmp_path / ".Creanova_instructions"
    ...
    assert skill.name == ".Creanova_instructions"  # Name derived from filename
...
def temp_skills_dir_with_cursorrules():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Create .Creanova/skills directory structure
