...
from Creanova.sdk.skills.installed import disable_skill, install_skill
...
def temp_user_skills_dir():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        skills_dir = root / ".Creanova" / "skills"
...
def temp_microagents_dir():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        microagents_dir = root / ".Creanova" / "microagents"
...
def test_load_user_skills_with_skills_directory(temp_user_skills_dir):
    """Test load_user_skills loads from .Creanova/skills directory."""
...
def test_load_user_skills_priority_order(tmp_path):
    """Test precedence .agents/skills > .Creanova/skills > microagents."""
...
def test_load_user_skills_merges_all_directories(tmp_path):
    """Test loading unique skills from .agents/skills, .Creanova/skills,
    microagents.
    """
    agents_dir = tmp_path / ".agents" / "skills"
    skills_dir = tmp_path / ".Creanova" / "skills"
