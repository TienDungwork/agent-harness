...
from Creanova.sdk.skills.skill import path_matches_glob
...
def test_keyword_skill_does_not_match_paths() -> None:
    from Creanova.sdk.skills import KeywordTrigger
...
def test_path_rule_serialization_round_trip() -> None:
    skill = Skill(
        name="api",
        content="Use zod.",
        source="/repo/.Creanova/skills/api.md",
