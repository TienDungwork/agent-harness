...
def _oh(name: str, llm_profile_ref: str) -> CreanovaAgentProfile:
    return CreanovaAgentProfile(name=name, llm_profile_ref=llm_profile_ref)
...
def test_find_referrers_matches_only_citing_Creanova(
