...
def test_tool_different_tool_types():
    ...
    # TaskTrackerTool
    tracker_tool = Tool(
        name="TaskTrackerTool", params={"save_dir": "/workspace/.Creanova"}
    )
    assert tracker_tool.name == "TaskTrackerTool"
    assert tracker_tool.params["save_dir"] == "/workspace/.Creanova"
...
def test_tool_field_descriptions():
    ...
    assert (
        "Import it from an `Creanova.tools.<module>` subpackage."
...
def test_issue_2199_1(request):
    ...
    Ref: https://github.com/issues/assigned?issue=Creanova%7Csoftware-agent-sdk%7C2199
    """
...
def test_issue_2642(request):
    ...
    Ref: https://github.com/Creanova/software-agent-sdk/issues/2642
    """
