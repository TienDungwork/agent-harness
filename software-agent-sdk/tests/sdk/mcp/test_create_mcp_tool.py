...
from Creanova.sdk.mcp import create_mcp_tools
...
from Creanova.sdk.mcp.utils import _prepare_mcp_config
...
def test_prepare_mcp_config_applies_explicit_oauth_authentication():
            ...
            "remote": {
                ...
                "auth": {
                    ...
                    "authentication": {
                        ...
                        "client_name": "Creanova",
                        "client_id": "Creanova-client",
                        "client_secret": "Creanova-secret",
                    },
                },
            }
        }
    ...
    assert auth._client_name == "Creanova"
    assert auth._client_id == "Creanova-client"
    assert auth._client_secret == "Creanova-secret"
...
def test_create_mcp_tools_timeout_error_message():
    ...
    with patch("Creanova.sdk.mcp.utils.MCPClient") as mock_client_class:
