...
These tests verify that grep behaves like Creanova:
...
import Creanova.tools.grep.impl as grep_impl
from Creanova.tools.grep import GrepAction
from Creanova.tools.grep.impl import GrepExecutor
from Creanova.tools.utils import _check_grep_available
