...
from Creanova.tools.apply_patch.definition import ApplyPatchAction, ApplyPatchExecutor
...
def test_create_modify_delete(tmp_ws: Path):
    ...
    assert fp.read_text() == ("Creanova SDK integrates tools.\nApplyPatch works.")
