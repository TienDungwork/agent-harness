...
from Creanova.sdk.hooks.config import HookConfig, HookDefinition, HookMatcher
from Creanova.sdk.subagent.registry import (
    _reset_registry_for_tests,
    register_agent,
)
from Creanova.sdk.subagent.schema import AgentDefinition
from Creanova.tools.preset import register_builtins_agents
from Creanova.tools.task.manager import (
    Task,
    TaskManager,
    TaskStatus,
)
...
class TestTaskManager:
    ...
    def test_create_task_prefers_factory_max_iteration_over_parent(self, tmp_path):
        ...
        from Creanova.sdk.subagent.registry import agent_definition_to_factory
...
class TestRunTask:
    ...
    @patch(
        "Creanova.tools.task.manager.get_agent_final_response",
...
class TestTaskManagerPersistence:
    ...
    def test_no_persistence_uses_tmp_dir(self, tmp_path):
        ...
        assert manager._persistence_dir is not None
        assert manager._persistence_dir.exists()
        assert "Creanova_tasks_" in str(manager._persistence_dir)
