...
from Creanova.tools.browser_use.event_storage import EventStorage
from Creanova.tools.browser_use.recording import (
    DEFAULT_CONFIG,
    RecordingSession,
)
...
class TestPeriodicFlush:
    ...
    async def test_periodic_flush_creates_new_file_chunks(
        ...
        from Creanova.tools.browser_use.recording import RecordingConfig
