...
from Creanova.tools.browser_use.impl import BrowserToolExecutor, _install_chromium
...
class TestChromiumDetection:
    ...
    def test_check_chromium_available_multiple_binaries(self):
        ...
        with (
            patch("Creanova.tools.browser_use.impl.sys.platform", "linux"),
            patch.object(Path, "exists", return_value=False),
    ...
    def test_check_chromium_available_standard_macos_path(self):
        ...
        with (
            patch("Creanova.tools.browser_use.impl.sys.platform", "darwin"),
            patch("shutil.which", return_value=None),
            patch.object(Path, "exists", mock_exists),
        ):
            result = executor.check_chromium_available()
    ...
    def test_check_chromium_available_standard_windows_edge_path(self):
        ...
        with (
            patch("Creanova.tools.browser_use.impl.sys.platform", "win32"),
            patch("shutil.which", return_value=None),
