...
from Creanova.tools.browser_use.definition import (
    BrowserClickAction,
    BrowserGetStateAction,
    BrowserNavigateAction,
    BrowserObservation,
)
from Creanova.tools.browser_use.impl import (
...
def test_browser_executor_rejects_non_positive_action_timeout():
    ...
    with patch("Creanova.tools.browser_use.impl.run_with_timeout"):
        with patch.object(BrowserToolExecutor, "_ensure_chromium_available"):
            with patch("Creanova.tools.browser_use.impl.CustomBrowserUseServer"):
                with patch("Creanova.tools.browser_use.impl.AsyncExecutor"):
                    with pytest.raises(
                        ValueError,
...
@patch("Creanova.tools.browser_use.impl.BrowserToolExecutor.navigate")
...
@patch("Creanova.tools.browser_use.impl.BrowserToolExecutor.click")
...
@patch("Creanova.tools.browser_use.impl.BrowserToolExecutor.get_state")
...
def test_issue_2412_consecutive_failures_reset_session(mock_browser_executor):
    ...
    See: https://github.com/Creanova/software-agent-sdk/issues/2412
    """
    from Creanova.tools.browser_use.impl import MAX_CONSECUTIVE_FAILURES
...
def test_issue_2412_degraded_timeout_after_failures(mock_browser_executor):
    ...
    See: https://github.com/Creanova/software-agent-sdk/issues/2412
    """
    from Creanova.tools.browser_use.impl import DEGRADED_TIMEOUT_SECONDS
...
async def test_start_recording_initializes_session(mock_browser_executor):
    ...
    from Creanova.tools.browser_use.recording import RecordingSession
