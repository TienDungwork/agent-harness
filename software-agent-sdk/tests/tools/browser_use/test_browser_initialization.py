...
from Creanova.tools.utils.timeout import TimeoutError
...
class TestBrowserInitialization:
    ...
    def test_initialization_timeout_handling(self):
        ...
        with (
            ...
            patch(
                "Creanova.tools.browser_use.impl.run_with_timeout",
    ...
    def test_initialization_custom_timeout(self):
        ...
        with (
            ...
            patch(
                "Creanova.tools.browser_use.impl.CustomBrowserUseServer",
                return_value=mock_server,
            ),
            patch("Creanova.tools.browser_use.impl.run_with_timeout") as mock_timeout,
        ):
    ...
    def test_initialization_config_passed_to_server(self):
        ...
        with (
            ...
            patch(
                "Creanova.tools.browser_use.impl.os.getuid",
                return_value=1000,
                create=True,
            ),  # Non-root user
        ):
    ...
    def test_initialization_async_executor_created(self):
        ...
        with (
            ...
            patch(
                "Creanova.tools.browser_use.impl.AsyncExecutor",
