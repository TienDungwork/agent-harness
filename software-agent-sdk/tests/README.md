---
title: Creanova Agent SDK Tests
description: Test suite structure and execution strategy for the Creanova Agent SDK. Includes unit tests, integration tests, and CI configuration.
---

# Creanova Agent SDK Tests

This directory contains the test suite for the Creanova Agent SDK.
...
- **SDK Tests** (`sdk/`): Run when changes are detected in `Creanova-sdk/**` or `tests/sdk/**`
- **Tools Tests** (`tools/`): Run when changes are detected in `Creanova-tools/**` or `tests/tools/**`
