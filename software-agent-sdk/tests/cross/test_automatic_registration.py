...
def test_bash_tool_automatic_registration():
    ...
    import Creanova.tools.terminal.definition  # noqa: F401
...
def test_file_editor_tool_automatic_registration():
    ...
    # Import the module to trigger registration
    import Creanova.tools.file_editor.definition  # noqa: F401
...
def test_task_tracker_tool_automatic_registration():
    ...
    # Import the module to trigger registration
    import Creanova.tools.task_tracker.definition  # noqa: F401
...
def test_browser_tool_automatic_registration():
    ...
    # Import the module to trigger registration
    import Creanova.tools.browser_use.definition  # noqa: F401
...
def test_browser_tool_usable_listing_respects_chromium_availability(
    ...
    import Creanova.tools.browser_use.definition  # noqa: F401
    from Creanova.sdk.tool.registry import list_usable_tools
    from Creanova.tools.browser_use.definition import BrowserToolSet
...
def test_grep_tool_automatic_registration():
    ...
    # Import the module to trigger registration
    import Creanova.tools.grep.definition  # noqa: F401
...
def test_glob_tool_automatic_registration():
    ...
    # Import the module to trigger registration
    import Creanova.tools.glob.definition  # noqa: F401
...
def test_planning_file_editor_tool_automatic_registration():
    ...
    # Import the module to trigger registration
    import Creanova.tools.planning_file_editor.definition  # noqa: F401
...
def test_import_from_init_triggers_registration():
    ...
    from Creanova.tools.terminal import TerminalTool  # noqa: F401
...
def test_tool_can_be_resolved_after_automatic_registration():
    ...
    import Creanova.tools.terminal.definition  # noqa: F401
    from Creanova.sdk.conversation.state import ConversationState
    from Creanova.sdk.tool.registry import resolve_tool
