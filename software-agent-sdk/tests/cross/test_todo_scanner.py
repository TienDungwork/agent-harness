...
def function1():
    # TODO(Creanova): Add input validation
    return "hello"

def function2():
    # TODO(Creanova): Implement error handling
    pass
"""
...
def test_scan_java_file():
    ...
    public void method() {
        // TODO(Creanova): Implement this method
...
def test_scan_rust_file():
    ...
    content = """fn main() {
    // TODO(Creanova): Add error handling
    println!("Hello, world!");
}"""
...
def test_scan_unsupported_file_extension():
    ...
    content = """// TODO(Creanova): This should be ignored"""
...
def test_scan_all_todos():
    """Test that all TODO(Creanova) comments are found."""
    content = """def test():
    # TODO(Creanova): This should be found
    # TODO(Creanova): This should also be found
    # TODO(Creanova): https://github.com/owner/repo/pull/123
    pass
"""
