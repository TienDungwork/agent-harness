...
from Creanova.sdk.conversation.visualizer import DefaultConversationVisualizer
...
def get_tools_for_preset(
    ...
    match preset:
        case "gemini":
            from Creanova.tools.preset.gemini import get_gemini_tools

            return get_gemini_tools(enable_browser=enable_browser)
        case "gpt5":
            from Creanova.tools.preset.gpt5 import get_gpt5_tools

            return get_gpt5_tools(enable_browser=enable_browser)
        case "planning":
            from Creanova.tools.preset.planning import get_planning_tools
...
class BaseIntegrationTest(ABC):
    ...
    Unlike the Creanova approach which uses a Runtime, this uses tools
