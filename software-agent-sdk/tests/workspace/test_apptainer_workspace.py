...
def mock_apptainer_workspace(tmp_path):
    ...
    from Creanova.workspace import ApptainerWorkspace
...
def test_apptainer_workspace_gpu_passthrough_flag(
    ...
    with patch(
        "Creanova.workspace.apptainer.workspace.subprocess.Popen",
...
def test_apptainer_workspace_extra_bind_mounts(mock_apptainer_workspace, monkeypatch):
    ...
    monkeypatch.setenv("Creanova_APPTAINER_EXTRA_BINDS", "/env/src:/env/dst:ro")
