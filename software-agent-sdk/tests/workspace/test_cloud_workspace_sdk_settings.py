"""Tests for CreanovaCloudWorkspace settings methods.
...
from Creanova.workspace.cloud.workspace import CreanovaCloudWorkspace
...
def mock_workspace():
    ...
    with patch.object(
        CreanovaCloudWorkspace, "model_post_init", lambda self, ctx: None
    ):
...
class TestGetLLM:
    """Tests for CreanovaCloudWorkspace.get_llm()."""
...
class TestGetSecrets:
    """Tests for CreanovaCloudWorkspace.get_secrets()."""
...
class TestGetMcpServers:
    """Tests for CreanovaCloudWorkspace.get_mcp_config()."""
