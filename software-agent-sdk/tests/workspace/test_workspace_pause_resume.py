...
def mock_docker_workspace():
    ...
    from Creanova.workspace import DockerWorkspace
...
def mock_api_workspace():
    ...
    from Creanova.workspace import APIRemoteWorkspace
...
def mock_cloud_workspace():
    """Create a mocked CreanovaCloudWorkspace with minimal setup."""
