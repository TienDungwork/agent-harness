"""Tests for repository cloning and skill loading in CreanovaCloudWorkspace."""
...
class TestCloudWorkspaceRepoMethods:
    """Tests for CreanovaCloudWorkspace repo methods."""

    @patch("Creanova.sdk.workspace.remote.base._clone_repos_helper")
    @patch.object(
        __import__(
            "Creanova.workspace.cloud.workspace", fromlist=["CreanovaCloudWorkspace"]
