"""Test CreanovaCloudWorkspace implementation."""
...
def test_sandbox_id_triggers_resume_instead_of_create():
    ...
    with (
        ...
        patch.object(CreanovaCloudWorkspace, "reset_client"),
    ):
...
def _make_local_workspace(**overrides):
    """Helper to create an CreanovaCloudWorkspace in local_agent_server_mode."""
    from Creanova.workspace import CreanovaCloudWorkspace
    ...
    return CreanovaCloudWorkspace(**kwargs)
