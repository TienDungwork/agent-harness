"""Tests for CreanovaCloudWorkspace automation tags functionality."""
...
class TestDefaultConversationTags:
    ...
    def workspace(self):
        ...
        with patch.object(CreanovaCloudWorkspace, "_start_sandbox"):
            workspace = CreanovaCloudWorkspace(
...
class TestConversationTagMerging:
    ...
    def test_merges_default_tags_with_user_tags(self):
        ...
        with patch(
            "Creanova.sdk.conversation.impl.remote_conversation.RemoteConversation"
        ) as mock_convo_class:
...
class TestPluginSourceUrl:
    ...
    def test_github_shorthand_basic(self):
        ...
        plugin = PluginSource(source="github:Creanova/skills")
        assert plugin.source_url == "https://github.com/Creanova/skills"

    def test_github_shorthand_with_ref(self):
        """Should add tree/ref for github: sources with ref."""
        from Creanova.sdk.plugin import PluginSource

        plugin = PluginSource(source="github:Creanova/skills", ref="v1.0.0")
        assert plugin.source_url == "https://github.com/Creanova/skills/tree/v1.0.0"
    ...
    def test_github_shorthand_with_repo_path(self):
        ...
        plugin = PluginSource(
            source="github:Creanova/monorepo", repo_path="plugins/security"
        )
        assert (
            plugin.source_url
            == "https://github.com/Creanova/monorepo/tree/main/plugins/security"
        )
    ...
    def test_github_shorthand_with_ref_and_path(self):
        ...
        plugin = PluginSource(
            source="github:Creanova/monorepo",
            ref="feature-branch",
            repo_path="plugins/security",
        )
        assert (
            plugin.source_url
            == "https://github.com/Creanova/monorepo/tree/feature-branch/plugins/security"
        )
    ...
    def test_urls_returned_as_is(self):
        ...
        # Full GitHub URL
        plugin = PluginSource(source="https://github.com/Creanova/skills")
        assert plugin.source_url == "https://github.com/Creanova/skills"

        # GitHub blob URL
        plugin = PluginSource(
            source="https://github.com/Creanova/skills/blob/main/SKILL.md"
        )
        assert (
            plugin.source_url
            == "https://github.com/Creanova/skills/blob/main/SKILL.md"
        )
...
class TestPluginsTagInConversation:
    ...
    def test_plugins_added_as_urls_in_tags(self):
        ...
        plugins = [
            PluginSource(source="github:Creanova/security-skill", ref="v1.0.0"),
            PluginSource(source="github:Creanova/review-skill"),
        ]
        ...
        with patch(
            ...
            assert (
                "https://github.com/Creanova/security-skill/tree/v1.0.0" in plugin_urls
            )
            assert "https://github.com/Creanova/review-skill" in plugin_urls
    ...
    def test_local_plugins_not_included_in_tags(self):
        ...
        plugins = [
            PluginSource(source="github:Creanova/skill"),
        ...
        with patch(
            ...
            assert effective_tags["plugins"] == "https://github.com/Creanova/skill"
    ...
    def test_plugins_tag_merges_with_other_tags(self):
        ...
        plugins = [PluginSource(source="github:Creanova/skill")]
