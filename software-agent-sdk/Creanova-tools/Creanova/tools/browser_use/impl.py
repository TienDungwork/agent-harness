...
from Creanova.sdk.tool import ToolExecutor
...
from Creanova.tools.browser_use.server import CustomBrowserUseServer
from Creanova.tools.utils.timeout import (
...
class BrowserToolExecutor(ToolExecutor[BrowserAction, BrowserObservation]):
    """Executor that wraps browser-use MCP server for Creanova integration."""
    ...
    async def get_state(self, include_screenshot: bool = False):
        ...
        from Creanova.tools.browser_use.definition import BrowserObservation
