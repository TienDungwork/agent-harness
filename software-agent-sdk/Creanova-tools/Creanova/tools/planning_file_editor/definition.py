...
class PlanningFileEditorTool(
    ...
    def create(
        ...
        from Creanova.tools.planning_file_editor.impl import (
        ...
        if plan_path is None:
            ...
            if legacy_plan_path.exists():
                ...
                logger.warning(
                    ...
                    f"for consistency with Creanova conventions."
                )
        ...
        if not plan_file.exists():
            # Import here to avoid circular imports
            from Creanova.tools.preset.planning import get_plan_headers
