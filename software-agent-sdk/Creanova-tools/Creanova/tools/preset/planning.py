...
def register_planning_tools() -> None:
    ...
    from Creanova.tools.glob import GlobTool  # noqa: F401
    from Creanova.tools.grep import GrepTool  # noqa: F401
    from Creanova.tools.planning_file_editor import (
...
def get_planning_tools(plan_path: str | None = None) -> list[Tool]:
    ...
    from Creanova.tools.glob import GlobTool
    from Creanova.tools.grep import GrepTool
    from Creanova.tools.planning_file_editor import PlanningFileEditorTool
