...
from Creanova.sdk.security import ConfirmationPolicyBase
from Creanova.sdk.subagent.registry import AgentFactory, get_agent_factory
        ...
        if self._parent_conversation is None:
            ...
            if parent_persistence_dir is not None:
                ...
                self._persistence_dir = Path(
                    tempfile.mkdtemp(prefix="Creanova_tasks_")
                )
