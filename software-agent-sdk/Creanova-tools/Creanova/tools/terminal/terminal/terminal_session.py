...
from Creanova.tools.terminal.timeout_policy import foreground_timeout_rejection_for
from Creanova.tools.terminal.utils.command import (
    escape_bash_special_chars,
    split_bash_commands,
)
from Creanova.tools.terminal.utils.escape_filter import TerminalQueryFilter
...
class TerminalSession(TerminalSessionBase):
    ...
    def _get_command_output(
        ...
        See: https://github.com/Creanova/software-agent-sdk/issues/2244
