...
The Terminal Tool provides a persistent shell session for executing bash commands within the Creanova SDK.
...
```python
from Creanova.sdk import Conversation
from Creanova.tools.terminal.definition import TerminalTool
...
```python
from Creanova.sdk import Conversation
from Creanova.tools.terminal.definition import TerminalTool, TerminalAction
