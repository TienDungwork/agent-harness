...
from Creanova.sdk.io.base import FileStore
from Creanova.sdk.io.cache import MemoryLRUCache
...
class InMemoryFileStore(FileStore):
    ...
    def get_absolute_path(self, path: str) -> str:
        ...
        return os.path.join(
            tempfile.gettempdir(), f"Creanova_inmemory_{self._instance_id}", path
        )
