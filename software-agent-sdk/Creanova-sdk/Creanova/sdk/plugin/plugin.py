...
from Creanova.sdk.plugin.fetch import fetch_plugin
from Creanova.sdk.plugin.types import (
    CommandDefinition,
    PluginAuthor,
    PluginManifest,
)
...
class Plugin(BaseModel):
    ...
    def fetch(
        ...
        Args:
            ...
            cache_dir: Directory for caching. Defaults to ~/.Creanova/cache/plugins/
