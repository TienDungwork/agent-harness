...
#: See https://github.com/Creanova/software-agent-sdk/issues/1745 for LSP support.
...
#: See Creanova.sdk.hooks.HookConfig for the full structure.
...
class CommandDefinition(BaseModel):
    ...
    def to_skill(self, plugin_name: str) -> Skill:
        ...
        """
        from Creanova.sdk.skills.skill import Skill
        from Creanova.sdk.skills.trigger import KeywordTrigger
