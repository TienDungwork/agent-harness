...
Example:
    ...
    >>> from Creanova.sdk.llm.exceptions import LLMContextWindowExceedError
...
from Creanova.sdk.llm.streaming import AnyTokenCallbackType, TokenCallbackType
from Creanova.sdk.llm.utils.metrics import MetricsSnapshot, TokenUsage
...
class TestLLM(LLM):
    ...
    Example:
        >>> from Creanova.sdk.testing import TestLLM
        >>> from Creanova.sdk.llm import Message, TextContent, MessageToolCall
        >>>
    ...
    def _content_to_string(self, message: Message) -> str:
        ...
        from Creanova.sdk.llm.message import TextContent
