...
from Creanova.sdk.observability.utils import get_env


if TYPE_CHECKING:
    from Creanova.sdk.conversation.types import TraceMetadataValue
...
def init_laminar_for_external():
    ...
    Example:
        ```python
        from Creanova.sdk.observability import init_laminar_for_external
        from lmnr import Laminar
