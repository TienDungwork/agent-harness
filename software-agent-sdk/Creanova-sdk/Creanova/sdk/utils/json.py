...
from Creanova.sdk.llm.exceptions import LLMResponseError
from Creanova.sdk.llm.utils.metrics import Metrics


class CreanovaJSONEncoder(json.JSONEncoder):
...
_json_encoder = CreanovaJSONEncoder()
...
def dumps(obj, **kwargs):
    ...
    if "cls" not in encoder_kwargs:
        encoder_kwargs["cls"] = CreanovaJSONEncoder
