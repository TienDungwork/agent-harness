...
Copies / consumers (keep in sync when changing):
  - Creanova/runtime-api  →  utils/redact.py  (partial copy)
  - All-Hands-AI/Creanova →  imports directly
"""
...
_API_KEY_LITERAL_RE = re.compile(
    ...
    r"|sk-oh-[A-Za-z0-9]{20,}"  # Creanova session tokens
...
def redact_api_key_literals(text: str) -> str:
    ...
    Creanova session tokens, etc.) anywhere in the text.
