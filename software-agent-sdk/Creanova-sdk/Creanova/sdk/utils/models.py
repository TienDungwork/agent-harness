...
class CreanovaModel(BaseModel):
    ...
    New code should extend pydantic.BaseModel directly instead of CreanovaModel.

    Existing code that extends CreanovaModel will continue to work, but
    migration to BaseModel is recommended.
    """


class DiscriminatedUnionMixin(CreanovaModel):
