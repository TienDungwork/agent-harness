...
from Creanova.sdk.hooks.types import HookDecision, HookEvent
...
class HookExecutor:
    ...
    def _execute_agent_hook(
        ...
        from Creanova.sdk.agent import Agent  # type: ignore[attr-defined]
    ...
    def execute(
        ...
        hook_env["Creanova_PROJECT_DIR"] = self.working_dir
        hook_env["Creanova_SESSION_ID"] = event.session_id or ""
        hook_env["Creanova_EVENT_TYPE"] = event.event_type
        if event.tool_name:
            hook_env["Creanova_TOOL_NAME"] = event.tool_name
