"""Installed skills management for Creanova SDK.
...
from Creanova.sdk.extensions.installation import (
    InstallationInfo,
...
from Creanova.sdk.skills.utils import find_skill_md
...
DEFAULT_INSTALLED_SKILLS_DIR = Path.home() / ".Creanova" / "skills" / "installed"
...
def install_skills_from_marketplace(
    ...
    from Creanova.sdk.plugin import resolve_source_path
