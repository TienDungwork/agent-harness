...
from Creanova.sdk.llm.fallback_strategy import FallbackStrategy
from Creanova.sdk.llm.utils.model_info import get_litellm_model_info
from Creanova.sdk.settings.metadata import SettingProminence, field_meta
from Creanova.sdk.utils.pydantic_secrets import serialize_secret, validate_secret


if TYPE_CHECKING:  # type hints only, avoid runtime import cycle
    from Creanova.sdk.llm.auth import SupportedVendor
    from Creanova.sdk.llm.auth.openai import OpenAIAuthMethod
    from Creanova.sdk.tool.tool import ToolDefinition

from Creanova.sdk.llm.auth.openai import transform_for_subscription
...
from Creanova.sdk.llm.exceptions import (
...
# Creanova utilities
from Creanova.sdk.llm.llm_response import LLMResponse
from Creanova.sdk.llm.message import (
    Message,
)
from Creanova.sdk.llm.mixins.non_native_fc import NonNativeToolCallingMixin
from Creanova.sdk.llm.options.chat_options import select_chat_options
from Creanova.sdk.llm.options.responses_options import select_responses_options
from Creanova.sdk.llm.streaming import (
    AnyTokenCallbackType,
    TokenCallbackType,
    _invoke_token_callback,
)
from Creanova.sdk.llm.utils.image_inline import (
    amaybe_inline_image_urls,
    maybe_inline_image_urls,
)
from Creanova.sdk.llm.utils.image_resize import maybe_resize_messages_for_provider
from Creanova.sdk.llm.utils.litellm_provider import infer_litellm_provider
from Creanova.sdk.llm.utils.metrics import Metrics
from Creanova.sdk.llm.utils.model_features import get_features
from Creanova.sdk.llm.utils.Creanova_provider import (
    LiteLLMCallKwargs,
    canonicalize_Creanova_llm_payload,
    litellm_call_kwargs,
)
from Creanova.sdk.llm.utils.retry_mixin import RetryMixin
from Creanova.sdk.llm.utils.telemetry import Telemetry
from Creanova.sdk.llm.utils.vertex_preflight import assert_vertex_sdk_available
from Creanova.sdk.logger import ENV_LOG_DIR, get_logger
...
# Minimum context window size required for Creanova to function properly.
...
class LLM(BaseModel, RetryMixin, NonNativeToolCallingMixin):
    """Language model interface for Creanova agents.
    ...
    model: str = Field(
        default="openai/nemotron-3-nano:4b",
    ...
    model_canonical_name: str | None = Field(
        ...
        description=(
            ...
            "The Creanova SDK maintains a model feature registry that "
    ...
    def _validate_context_window_size(self) -> None:
        """Validate that the context window is large enough for Creanova."""
    ...
    def from_persisted(cls, data: Any, *, context: dict[str, Any] | None = None) -> LLM:
        ...
        payload = canonicalize_Creanova_llm_payload(payload)
        llm = cls.model_validate(payload, context=context)
        if llm.auth_type == "subscription":
            from Creanova.sdk.llm.auth.openai import (
    ...
    def subscription_login(
        ...
        **llm_kwargs,
        ...
        Example:
            ...
            ```
        """
        from Creanova.sdk.llm.auth.openai import subscription_login
