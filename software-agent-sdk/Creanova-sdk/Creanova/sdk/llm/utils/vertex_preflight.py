...
`google-cloud-aiplatform` is an optional extra (`Creanova-sdk[vertex]`). When a
...
from Creanova.sdk.llm.exceptions import LLMBadRequestError


_INSTALL_HINT = (
    "Vertex AI partner models require the Vertex SDK. "
    'Install with: pip install "Creanova-sdk[vertex]"'
)
