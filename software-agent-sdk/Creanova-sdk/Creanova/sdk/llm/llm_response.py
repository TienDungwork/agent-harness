...
with Creanova-native types, eliminating the need for consumers to work directly
with LiteLLM types.
"""
...
class LLMResponse(BaseModel):
    ...
    only Creanova-native types to consumers while preserving access to the
    raw LiteLLM response for internal use.

    Attributes:
        message: The completion message converted to Creanova Message type
