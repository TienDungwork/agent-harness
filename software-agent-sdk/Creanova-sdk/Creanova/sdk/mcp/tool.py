...
if TYPE_CHECKING:
    from Creanova.sdk.conversation import LocalConversation
...
from Creanova.sdk.llm import TextContent
...
from Creanova.sdk.security import risk
from Creanova.sdk.skills.utils import expand_variable_references
...
from Creanova.sdk.tool.schema import Schema, _process_schema_node
from Creanova.sdk.tool.tool import _prioritize_schema_fields
...
class MCPToolDefinition(ToolDefinition[MCPToolAction, MCPToolObservation]):
    ...
    def action_from_arguments(self, arguments: dict[str, Any]) -> MCPToolAction:
        ...
        # internal to Creanova and not part of the MCP tool schema
    ...
    def _get_tool_schema(
        ...
        Creanova-specific fields (``security_risk``, ``summary``) directly.

        See: https://github.com/Creanova/software-agent-sdk/issues/3955
        """
