...
from Creanova.sdk.mcp.exceptions import MCPTimeoutError
...
def _prepare_mcp_config(
    ...
    *,
    ...
    """Validate MCP config and apply explicit Creanova runtime auth metadata."""
...
def create_mcp_tools(
    ...
    *,
    ...
    """Create MCP tools from Creanova-native MCP server settings.
