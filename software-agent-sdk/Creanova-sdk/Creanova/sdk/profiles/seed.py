"""Build the default :class:`~Creanova.sdk.profiles.AgentProfile` from live settings.

The inverse of :func:`~Creanova.sdk.profiles.resolve_agent_profile`: turns the
...
if TYPE_CHECKING:
    from Creanova.sdk.settings import AgentSettingsConfig
...
def build_seed_profile(
    ...
    *,
    ...
    ``mcp_server_refs=None`` exposes all of the user's MCP servers; an Creanova
