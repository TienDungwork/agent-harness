...
from Creanova.sdk.critic.base import CriticBase, CriticResult
from Creanova.sdk.critic.impl.api.client import CriticClient
from Creanova.sdk.critic.impl.api.taxonomy import categorize_features


if TYPE_CHECKING:
    from Creanova.sdk.event import LLMConvertibleEvent
...
class APIBasedCritic(CriticBase, CriticClient):
    ...
    def evaluate(
        ...
        from Creanova.sdk.event import LLMConvertibleEvent, SystemPromptEvent
