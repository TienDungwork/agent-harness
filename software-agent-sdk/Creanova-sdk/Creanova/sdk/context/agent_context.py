...
from Creanova.sdk.context.prompts import render_template
from Creanova.sdk.context.prompts.presets import create_registry
from Creanova.sdk.context.prompts.section import PromptContext
...
from Creanova.sdk.secret import SecretSource, SecretValue
...
class AgentContext(BaseModel):
    ...
    load_user_skills: bool = Field(
        default=False,
        description=(
            "Whether to automatically load user skills from ~/.Creanova/skills/ "
            "and ~/.Creanova/microagents/ (for backward compatibility). "
        ),
        json_schema_extra={"acp_compatible": True},
    )
    load_public_skills: bool = Field(
        default=False,
        description=(
            "Whether to automatically load skills from the public Creanova "
            "skills repository at https://github.com/Creanova/extensions. "
    ...
    load_project_skills: bool = Field(
        ...
        description=(
            ...
            "workspace (e.g. .Creanova/skills/, AGENTS.md). Unlike "
