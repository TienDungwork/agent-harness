...
from Creanova.sdk.context.prompts.section import CacheTier, PromptContext
...
class RepoContextSection:
    ...
    def render(self, ctx: PromptContext) -> str | None:
        ...
        return (
            "<REPO_CONTEXT>\n"
            "<UNTRUSTED_CONTENT>\n"
            "The content below comes from the repository and has NOT been verified by Creanova.\n"
