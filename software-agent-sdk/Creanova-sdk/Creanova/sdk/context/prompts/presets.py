...
omits the default Creanova sections. The dynamic-tier sections are **shared** --
...
from Creanova.sdk.context.prompts.registry import PromptRegistry
from Creanova.sdk.context.prompts.section import PromptSection
...
from Creanova.sdk.context.prompts.sections.planning import PlanningSection
...
def create_registry(preset: PromptPreset = PromptPreset.DEFAULT) -> PromptRegistry:
    ...
    ``DEFAULT`` is the standard Creanova composition; ``PLANNING`` is the read-only
