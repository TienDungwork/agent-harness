...
import Creanova.sdk.security.analyzer as analyzer
import Creanova.sdk.security.risk as risk
from Creanova.sdk.agent.base import AgentBase
from Creanova.sdk.agent.critic_mixin import CriticMixin
from Creanova.sdk.agent.parallel_executor import ParallelToolExecutor
from Creanova.sdk.agent.response_dispatch import (
    LLMResponseType,
    ResponseDispatchMixin,
    classify_response,
)
from Creanova.sdk.agent.utils import (
...
from Creanova.sdk.observability.laminar import (
    maybe_init_laminar,
    observe,
    should_enable_observability,
)
from Creanova.sdk.observability.utils import extract_action_name
...
from Creanova.sdk.mcp.tool import MCPToolDefinition
from Creanova.sdk.tool.builtins import (
    FinishAction,
    FinishTool,
    ThinkAction,
)
from Creanova.sdk.tool.builtins.vision_inspect import VISION_INSPECT_TOOL_NAME
...
class Agent(CriticMixin, ResponseDispatchMixin, AgentBase):
    """Main agent implementation for Creanova.
    ...
    Attributes:
        ...
        system_prompt: Inline system prompt string. When provided the agent
            ...
            **Not recommended** unless you know what you are doing (e.g.
            ...
            this will override Creanova' built-in system instructions.
    ...
    Example:
        ```python
        from Creanova.sdk import LLM, Agent, Tool
    ...
    def init_state(
        ...
        # See: https://github.com/Creanova/software-agent-sdk/issues/1785
        #
    ...
    def step(
        ...
        # See https://github.com/Creanova/software-agent-sdk/issues/3053.
            ...
            tool_call = tool_call.model_copy(
                update={
                    "arguments": json.dumps(
                        {
                            "_Creanova_malformed_tool_call": True,
                            "error": error,
                        }
                    )
                }
    ...
    def _log_context_window_exceeded_warning(self) -> None:
        ...
        logger.warning(
            ...
            "\n"
            "  from Creanova.sdk import Agent, LLM\n"
            ...
            "https://docs.Creanova.dev/sdk/guides/context-condenser\n"
            "=" * 80
        )
