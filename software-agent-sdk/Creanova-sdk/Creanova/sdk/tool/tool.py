...
class ToolAnnotations(BaseModel):
    ...
    model_config: ClassVar[ConfigDict] = ConfigDict(
        ...
        title="Creanova.sdk.tool.tool.ToolAnnotations",
    )
    ...
    def __call__(
        ...
        Args:
            ...
            conversation: The conversation context for the tool execution.
                         ...
                         tool execution. See https://github.com/Creanova/agent-sdk/pull/925
                         for more details.
...
class ToolDefinition[ActionT, ObservationT](DiscriminatedUnionMixin, ABC):
    ...
    def resolve_kind(cls, kind: str) -> type:
        ...
        error_msg = (
            ...
            f"CreanovaModel instead of BaseModel to make sure that an invalid "
...
def _prioritize_schema_fields(
    ...
    See https://github.com/Creanova/software-agent-sdk/issues/1911
    """
