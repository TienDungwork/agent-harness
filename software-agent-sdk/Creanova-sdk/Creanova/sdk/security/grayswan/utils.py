"""Utility for converting Creanova SDK events to OpenAI message format.
...
from Creanova.sdk.llm import ImageContent, TextContent, content_to_str
...
def convert_events_to_openai_messages(
    ...
    """Convert Creanova SDK events to OpenAI message format for LLM APIs.
