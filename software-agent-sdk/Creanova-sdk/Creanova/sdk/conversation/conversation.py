...
from Creanova.sdk.secret import SecretValue
from Creanova.sdk.tool.client_tool import ClientToolSpec
from Creanova.sdk.utils.redact import redact_url_credentials
...
class Conversation:
    """Factory class for creating conversation instances with Creanova agents.
    ...
    def __new__(
        ...
        *,
        ...
        from Creanova.sdk.conversation.impl.local_conversation import LocalConversation
        from Creanova.sdk.conversation.impl.remote_conversation import (
            RemoteConversation,
        )
