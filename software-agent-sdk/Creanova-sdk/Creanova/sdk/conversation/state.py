...
from Creanova.sdk.conversation.event_store import ROOT_PARENT_ID, EventLog
from Creanova.sdk.conversation.fifo_lock import FIFOLock
from Creanova.sdk.conversation.persistence_const import BASE_STATE, EVENTS_DIR
...
from Creanova.sdk.io import FileStore, InMemoryFileStore, LocalFileStore
...
class ConversationState(CreanovaModel):
    ...
    agent_state: dict[str, Any] = Field(
        ...
        "See https://docs.Creanova.dev/sdk/guides/convo-persistence#how-state-persistence-works",
    )
