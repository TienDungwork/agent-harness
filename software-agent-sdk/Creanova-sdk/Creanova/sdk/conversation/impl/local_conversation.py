...
from Creanova.sdk.context.prompts.prompt import render_template
...
from Creanova.sdk.conversation.exceptions import ConversationRunError
from Creanova.sdk.conversation.secret_registry import SecretValue
from Creanova.sdk.conversation.state import (
    ConversationExecutionStatus,
    ConversationState,
)
from Creanova.sdk.conversation.stuck_detector import StuckDetector
from Creanova.sdk.conversation.title_utils import generate_conversation_title
...
from Creanova.sdk.event.conversation_error import ConversationErrorEvent
from Creanova.sdk.hooks import HookConfig, HookEventProcessor, create_hook_callback
from Creanova.sdk.io import FileStore, LocalFileStore
from Creanova.sdk.llm import LLM, Message, TextContent, content_to_str
from Creanova.sdk.llm.auth.openai import create_subscription_llm_from_config
from Creanova.sdk.llm.llm import LLMCallContext
from Creanova.sdk.llm.llm_profile_store import LLMProfileStore
from Creanova.sdk.llm.llm_registry import LLMRegistry
from Creanova.sdk.logger import get_logger
from Creanova.sdk.marketplace.registry import MarketplaceRegistry
from Creanova.sdk.mcp.config import MCPServer, coerce_mcp_config, dump_mcp_config
from Creanova.sdk.mcp.utils import DefaultMCPToolProvider, MCPToolProvider
from Creanova.sdk.observability.laminar import observe
from Creanova.sdk.plugin import (
    Plugin,
    PluginSource,
...
from Creanova.sdk.skills import load_available_skills, merge_skills_by_name
from Creanova.sdk.skills.utils import (
...
from Creanova.sdk.tool import ToolDefinition
from Creanova.sdk.tool.builtins import InvokeSkillTool
from Creanova.sdk.tool.client_tool import ClientToolSpec
from Creanova.sdk.tool.schema import Action, Observation
...
class LocalConversation(BaseConversation):
    ...
    def __init__(
        ...
        **_: object,
        ...
        if resolved_client_tools:
            from Creanova.sdk.tool.client_tool import register_client_tools
    ...
    def _recover_persisted_client_tools(
        ...
        from Creanova.sdk.conversation.persistence_const import BASE_STATE
        from Creanova.sdk.tool.client_tool import extract_client_tool_specs
        from Creanova.sdk.tool.spec import Tool
    ...
    def _runtime_mcp_tools_for_agent(self) -> list[ToolDefinition]:
        if not self.agent.supports_Creanova_tools or not self.agent.mcp_config:
            return []
    ...
    def _register_file_based_agents(self) -> None:
        ...
        Registration order (highest to lowest priority):
          ...
          3. Project-level file agents (`{project}/.agents/agents/*.md`,
                then `{project}/.Creanova/agents/*.md`)
          4. User-level file agents (`~/.agents/agents/*.md`,
                then `~/.Creanova/agents/*.md`)
        """
    ...
    def _ensure_agent_ready(self) -> None:
        ...
        with self._state:
            ...
            try:
                if self.agent.supports_Creanova_tools:
    ...
    def switch_acp_model(self, model: str) -> None:
        ...
        Unlike :meth:`switch_llm`, which swaps Creanova' own LLM object, this
    ...
    def interrupt(self) -> None:
        ...
        :class:`~Creanova.sdk.event.InterruptEvent`.
    ...
    def ask_agent(self, question: str) -> str:
        ...
        from Creanova.sdk.agent.utils import make_llm_completion, prepare_llm_messages
