...
from Creanova.sdk.conversation.base import BaseConversation, ConversationStateProtocol
...
from Creanova.sdk.conversation.exceptions import (
...
from Creanova.sdk.event.conversation_state import (
    FULL_STATE_KEY,
    ConversationStateUpdateEvent,
)
from Creanova.sdk.event.llm_completion_log import LLMCompletionLogEvent
from Creanova.sdk.event.types import EventID
from Creanova.sdk.hooks import HookConfig
from Creanova.sdk.llm import LLM, Message, TextContent
...
from Creanova.sdk.tool.client_tool import ClientTool, ClientToolSpec
from Creanova.sdk.utils.redact import http_error_log_content
from Creanova.sdk.workspace import LocalWorkspace, RemoteWorkspace
...
class RemoteConversation(BaseConversation):
    ...
    def __init__(
        ...
        **_: object,
        ...
        if should_create:
            ...
            from Creanova.sdk.subagent.registry import get_registered_agent_definitions
            from Creanova.sdk.tool.registry import get_tool_module_qualnames
        ...
        ws_timeout = float(os.getenv("Creanova_REMOTE_WS_READY_TIMEOUT", "30"))
        if not self._ws_client.wait_until_ready(timeout=ws_timeout):
            if os.getenv("Creanova_REMOTE_WS_READY_REQUIRED", "true").lower() in (
                "0",
                "false",
                "no",
            ):
                logger.warning(
                    ...
                    "reconciliation because Creanova_REMOTE_WS_READY_REQUIRED "
                    "is false.",
                    ws_timeout,
                    self._id,
                )
    ...
    def update_secrets(self, secrets: Mapping[str, SecretValue]) -> None:
        from Creanova.sdk.secret.secrets import SecretSource
