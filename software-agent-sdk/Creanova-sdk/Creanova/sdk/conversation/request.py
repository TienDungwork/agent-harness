...
from Creanova.sdk.agent.acp_agent import ACPAgent as ACPAgent
from Creanova.sdk.agent.agent import Agent as Agent
...
from Creanova.sdk.llm.message import ImageContent, Message, TextContent
...
from Creanova.sdk.utils.models import kind_of
...
class StartConversationRequest(BaseModel):
    ...
    Creanova agents and ACP agents. Clients may provide either a concrete
    ...
    title_llm_profile: str | None = Field(
        ...
        description=(
            ...
            "is loaded from LLMProfileStore (~/.Creanova/profiles/) and used "
...
class StartACPConversationRequest(StartConversationRequest):
    ...
    Creanova agents and ACP agents through the same request contract.
    """
