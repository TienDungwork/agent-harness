...
This document describes the automated release workflows for the Creanova Software Agent SDK.
...
1. Go to the [Actions tab](https://github.com/Creanova/software-agent-sdk/actions)
...
1. Go to [Releases](https://github.com/Creanova/software-agent-sdk/releases/new)
...
- ✅ Build all packages (Creanova-sdk, Creanova-tools, Creanova-workspace, Creanova-agent-server)
- ✅ Publish them to PyPI

You can monitor the progress in the [Actions tab](https://github.com/Creanova/software-agent-sdk/actions/workflows/pypi-release.yml).
...
- ✅ Verifies that the multi-arch Docker manifest
  `ghcr.io/Creanova/agent-server:<image-tag>-<variant>` published by
...
- **[Creanova](https://github.com/Creanova/Creanova)** - Updates `Creanova-sdk`, `Creanova-tools`, and `Creanova-agent-server` versions
- **[Creanova-CLI](https://github.com/Creanova/Creanova-cli)** - Updates `Creanova-sdk` and `Creanova-tools` versions
- **[automation](https://github.com/Creanova/automation)** - Updates `Creanova-sdk` and `Creanova-workspace` versions. Opened with a `fix:` title so the repo's release-please cuts a patch release, publishing an `Creanova-automation` build pinned to this SDK (which the agent-canvas `sdk-version-sync` check requires).
- **[typescript-client](https://github.com/Creanova/typescript-client)** - Updates the pinned `agent-server` image tag (`config.agentServerImage`); runs as a separate job that waits on the GHCR image rather than PyPI.
...
- [ ] Review and merge the auto-created version bump PRs in Creanova, Creanova-CLI, automation, and typescript-client (merging the automation PR triggers its release-please release PR; merge that too to publish the pinned `Creanova-automation`)
- [ ] Run evaluation on Creanova Index (manual step)
...
1. Go to the [Actions tab](https://github.com/Creanova/software-agent-sdk/actions)
2. Select **"Publish all Creanova packages (uv)"** workflow
...
- Check that the `PYPI_TOKEN_Creanova` secret is properly configured
