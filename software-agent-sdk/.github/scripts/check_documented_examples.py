...
def main() -> None:
    ...
    if undocumented:
        ...
        print("   git clone https://github.com/Creanova/docs.git")
        print()
        ...
        print(
            "   https://github.com/Creanova/docs/blob/main/.github/scripts/README.md"
        )
        print()
        print("5. Example documentation files can be found in:")
        print("   https://github.com/Creanova/docs/tree/main/sdk/guides")
        print()
