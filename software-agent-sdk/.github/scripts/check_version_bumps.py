...
PACKAGE_PYPROJECTS: dict[str, Path] = {
    "Creanova-sdk": Path("Creanova-sdk/pyproject.toml"),
    "Creanova-tools": Path("Creanova-tools/pyproject.toml"),
    "Creanova-workspace": Path("Creanova-workspace/pyproject.toml"),
    "Creanova-agent-server": Path("Creanova-agent-server/pyproject.toml"),
}
