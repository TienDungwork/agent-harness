...
DUPLICATE_VETO_MARKER = "<!-- Creanova-duplicate-veto -->"
AUTOMATION_BOT_LOGINS = {"all-hands-bot"}
REPOSITORY_PATTERN = re.compile(r"^[a-zA-Z0-9_.-]+/[a-zA-Z0-9_.-]+$")
DUPLICATE_MARKER_RE = re.compile(
    r"<!-- Creanova-duplicate-check canonical=(?P<canonical>\d+) "
...
def github_headers() -> dict[str, str]:
    ...
    return {
        ...
        "User-Agent": "Creanova-duplicate-auto-close",
    ...
    request_json(
        ...
        body={
            "body": (
                ...
                "(Creanova) on behalf of the repository maintainer._"
            )
        },
    )
    return True
