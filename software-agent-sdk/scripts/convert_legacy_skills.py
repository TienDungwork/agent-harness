#!/usr/bin/env python3
"""Convert legacy Creanova skills to AgentSkills standard format.
...
- Preserves Creanova-specific fields (triggers, inputs) for compatibility
...
def generate_description(
    ...
    return "A skill for Creanova agent."
...
def convert_legacy_skill(
    ...
    """Convert a legacy Creanova skill to AgentSkills format."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert legacy Creanova skills to AgentSkills standard format",
