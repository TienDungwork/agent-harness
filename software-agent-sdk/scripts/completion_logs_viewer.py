"""Streamlit app to explore Creanova completion logs.
...
* Environment variable ``Creanova_COMPLETION_LOGS_ROOT``
...
from Creanova.sdk.logger import ENV_LOG_DIR


ENV_ROOT = os.getenv("Creanova_COMPLETION_LOGS_ROOT")
DEFAULT_LOG_ROOT = Path(os.path.join(ENV_LOG_DIR, "completion_logs"))

st.set_page_config(page_title="Creanova Completion Logs Viewer", layout="wide")
...
def main() -> None:
    st.title("Creanova Completion Logs Viewer")
    ...
    root_input = st.sidebar.text_input(
        ...
        help="Root folder containing Creanova completion logs",
    )
