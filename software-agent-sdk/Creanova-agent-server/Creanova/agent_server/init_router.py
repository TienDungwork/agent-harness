...
See: https://github.com/Creanova/software-agent-sdk/issues/2523
"""
...
from Creanova.agent_server.bash_service import BashEventService
...
from Creanova.agent_server.server_details_router import mark_initialization_complete
...
class InitService:
    ...
    async def initialize(self, req: InitRequest) -> InitStatus:
        ...
        try:
            ...
            from Creanova.agent_server import conversation_service as cs_mod
            ...
            from Creanova.agent_server.api import _get_root_path
