...
These models mirror the structure used in Creanova app-server for consistency,
...
class Secrets(BaseModel):
    ...
    Unlike Creanova app-server which also stores provider tokens,
...
#   Creanova.sdk.settings.api_models (SecretCreateRequest, SecretItemResponse, etc.)
