"""Plugins router for Creanova Agent Server.
...
from Creanova.agent_server.plugins_service import (
...
from Creanova.sdk.plugin import InstalledPluginInfo, Plugin, PluginFetchError
...
class InstallPluginRequest(BaseModel):
    ...
    source: str = Field(
        ...
        description=(
            ...
            "'github:Creanova/extensions/plugins/city-weather', '/path/to/plugin'"
        ),
    )
    ref: str | None = Field(
...
def get_marketplace_catalog() -> MarketplaceCatalogResponse:
    ...
    from the Creanova extensions repository marketplace, each with attachable
