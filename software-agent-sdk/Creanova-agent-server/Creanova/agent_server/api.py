...
from Creanova.agent_server.agent_profiles_router import agent_profiles_router
from Creanova.agent_server.auth_router import auth_router
from Creanova.agent_server.bash_router import bash_router
from Creanova.agent_server.bash_service import get_default_bash_event_service
from Creanova.agent_server.config import (
    Config,
    get_default_config,
)
from Creanova.agent_server.conversation_router import conversation_router
from Creanova.agent_server.conversation_service import (
    get_default_conversation_service,
)
from Creanova.agent_server.dependencies import (
    check_session_api_key,
    check_workspace_session,
)
from Creanova.agent_server.desktop_router import desktop_router
from Creanova.agent_server.desktop_service import get_desktop_service
from Creanova.agent_server.event_router import event_router
from Creanova.agent_server.file_router import file_router
from Creanova.agent_server.git_router import git_router
from Creanova.agent_server.hooks_router import hooks_router
from Creanova.agent_server.init_router import (
    InitService,
    init_router,
    require_initialized,
)
from Creanova.agent_server.llm_router import llm_router
from Creanova.agent_server.mcp_router import mcp_router
from Creanova.agent_server.middleware import CORSDispatcher
from Creanova.agent_server.openai.router import (
    check_openai_api_key,
    openai_router,
)
from Creanova.agent_server.plugins_router import plugins_router
from Creanova.agent_server.profiles_router import profiles_router
from Creanova.agent_server.server_details_router import (
    get_server_info,
    mark_initialization_complete,
    server_details_router,
)
from Creanova.agent_server.settings_router import settings_router
from Creanova.agent_server.skills_router import skills_router
from Creanova.agent_server.sockets import sockets_router
from Creanova.agent_server.sub_agents_router import sub_agents_router
from Creanova.agent_server.tool_preload_service import get_tool_preload_service
from Creanova.agent_server.tool_router import tool_router
from Creanova.agent_server.vscode_router import vscode_router
from Creanova.agent_server.vscode_service import get_vscode_service
from Creanova.agent_server.workspace_router import workspace_router
from Creanova.agent_server.workspaces_router import workspaces_router
from Creanova.sdk.logger import DEBUG, get_logger
from Creanova.sdk.utils.redact import sanitize_dict
from Creanova.tools.terminal.constants import TMUX_SOCKET_NAME
...
def _default_server_tmux_tmpdir() -> Path:
    return Path(tempfile.gettempdir()) / f"Creanova-agent-server-{os.getpid()}"
...
def _cleanup_stale_tmux_sessions() -> None:
    ...
    This function kills all existing sessions on the shared Creanova tmux socket
...
def _create_fastapi_instance(config: Config) -> FastAPI:
    ...
    """
    return FastAPI(
        title="Creanova Agent Server",
        description=(
            "Creanova Agent Server - REST/WebSocket interface for Creanova AI Agent"
        ),
