...
from Creanova.agent_server.logging_config import LOGGING_CONFIG
...
def check_browser():
    ...
    try:
        ...
        from Creanova.tools.preset.default import register_default_tools

        register_default_tools(enable_browser=True)

        # Import browser components
        from Creanova.tools.browser_use.definition import BrowserNavigateAction
        from Creanova.tools.browser_use.impl import BrowserToolExecutor
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Creanova Agent Server App")
    parser.add_argument(
    ...
    print(f"Starting Creanova Agent Server on {args.host}:{args.port}")
