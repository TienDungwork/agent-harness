"""Sub-agents router for Creanova Agent Server.
...
from Creanova.tools.preset.default import discover_builtin_agents
...
class SubAgentsRequest(BaseModel):
    ...
    load_user: bool = Field(
        default=True,
        description="Load user agents from ~/.agents/agents and ~/.Creanova/agents",
    )
