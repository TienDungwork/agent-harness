...
reference-bearing :class:`~Creanova.sdk.profiles.AgentProfile` union and keeps a
...
MCP references and returns :class:`~Creanova.sdk.profiles.AgentProfileDiagnostics`
...
from Creanova.agent_server._secrets_exposure import get_cipher, get_config
...
from Creanova.agent_server.profiles_router import MAX_PROFILES, _has_api_key
from Creanova.agent_server.skills_service import discover_profile_skills
from Creanova.sdk.llm import LLM
from Creanova.sdk.llm.llm_profile_store import (
...
from Creanova.sdk.profiles.agent_profile_store import PROFILE_NAME_PATTERN
...
async def materialize_agent_profile(
    ...
    # (catalog minus ``disabled_skills``) resolve. Only Creanova profiles carry
