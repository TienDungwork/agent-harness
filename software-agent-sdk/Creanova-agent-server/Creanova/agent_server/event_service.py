...
from Creanova.agent_server.pub_sub import PubSub, Subscriber
from Creanova.sdk import LLM, AgentBase, Event, Message, TextContent, get_logger
...
from Creanova.sdk.conversation.goal import (
    GoalController,
    GoalDone,
    GoalOutcome,
    GoalStatus,
...
from Creanova.sdk.conversation.goal.prompts import RESUME_PROMPT
from Creanova.sdk.conversation.impl.local_conversation import (
...
from Creanova.sdk.llm.streaming import LLMStreamChunk
from Creanova.sdk.mcp.utils import MCPToolProvider
from Creanova.sdk.security.analyzer import SecurityAnalyzerBase
from Creanova.sdk.security.confirmation_policy import ConfirmationPolicyBase
from Creanova.sdk.utils.async_utils import AsyncCallbackWrapper
...
class EventService:
    ...
    def _event_matches_body(self, event: Event, body: str) -> bool:
        ...
        from Creanova.sdk.llm.message import content_to_str
    ...
    async def start(self):
        ...
        # Hook execution semantics: Creanova runs hooks sequentially with early-exit
