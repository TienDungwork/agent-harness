"""Skills service for Creanova Agent Server.
...
Skill Sources:
- Public skills: registered marketplace plugins or GitHub Creanova/extensions
- User skills: ~/.Creanova/skills/ and ~/.Creanova/microagents/
- Project skills: {workspace}/.Creanova/skills/, .cursorrules, agents.md
- Organization skills: {org}/.Creanova or {org}/Creanova-config
...
from Creanova.sdk.marketplace.registration import MarketplaceRegistration
...
from Creanova.sdk.skills.skill import (
...
from Creanova.sdk.utils import sanitized_env
...
def load_org_skills_from_url(
    ...
    # the same org_name (e.g. {login}/.Creanova and {login}/.agents), and
    ...
    if working_dir:
        ...
        temp_dir = Path(tempfile.mkdtemp(prefix=f"Creanova_org_skills_{org_name}_"))
...
def discover_profile_skills() -> list[Skill]:
    """Skill catalog an Creanova profile launches with (#4017).
...
def sync_public_skills() -> tuple[bool, str]:
    ...
    the latest skills from the Creanova/extensions repository.
...
def service_install_skill(
    ...
    Args:
        source: Skill source - git URL, GitHub shorthand, or local path.
            ...
            - GitHub URL: https://github.com/Creanova/extensions/tree/main/skills/github
            - GitHub shorthand: github:Creanova/extensions/skills/github
        ...
        installed_dir: Directory for installed skills.
            Defaults to ~/.Creanova/skills/installed/.
