"""Skills router for Creanova Agent Server.
...
from Creanova.agent_server.skills_service import (
    ExposedUrlData,
...
from Creanova.sdk.extensions.fetch import ExtensionFetchError
...
from Creanova.sdk.skills.skill import DEFAULT_MARKETPLACE_PATH
from Creanova.sdk.skills.utils import SKILL_NAME_PATTERN
...
class SkillsRequest(BaseModel):
    ...
    load_public: bool = Field(
        default=True, description="Load public skills from Creanova/extensions repo"
    )
    load_user: bool = Field(
        default=True, description="Load user skills from ~/.Creanova/skills/"
    )
...
class InstallSkillRequest(BaseModel):
    ...
    source: str = Field(
        ...
        description=(
            ...
            "Examples: "
            "'https://github.com/Creanova/extensions/tree/main/skills/github', "
            "'github:Creanova/extensions/skills/github', "
            "'/path/to/skill'"
        ),
    )
    ref: str | None = Field(
...
def get_skills(request: SkillsRequest, http_request: Request) -> SkillsResponse:
    ...
    2. Public skills - From GitHub Creanova/extensions repository
    3. User skills - From ~/.Creanova/skills/
    4. Organization skills - From {org}/.Creanova or equivalent
    5. Project skills (highest) - From {workspace}/.Creanova/skills/
...
def install_skill_endpoint(request: InstallSkillRequest) -> InstalledSkillResponse:
    ...
    the user's installed skills directory (~/.Creanova/skills/installed/).
...
def list_installed_skills_endpoint() -> InstalledSkillsListResponse:
    ...
    directory (~/.Creanova/skills/installed/).
...
def get_marketplace_catalog() -> MarketplaceCatalogResponse:
    ...
    Returns a list of available skills from the Creanova extensions
