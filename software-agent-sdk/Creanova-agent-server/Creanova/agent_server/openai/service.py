...
from Creanova.agent_server.event_service import EventService
...
from Creanova.sdk import LLM, Message
from Creanova.sdk.context.agent_context import AgentContext
from Creanova.sdk.conversation.request import (
    SendMessageRequest,
...
from Creanova.sdk.llm.message import ImageContent, TextContent
from Creanova.sdk.settings import ACPAgentSettings, CreanovaAgentSettings
from Creanova.sdk.workspace import LocalWorkspace


_MODEL_PREFIX = "Creanova_"
...
def _profile_name_from_model(model: str) -> str:
    ...
    raise HTTPException(
        ...
        detail=f"Unknown Creanova model '{model}'. Use GET /v1/models.",
    )
...
def _with_profile_llm_and_system_text(
    ...
    if isinstance(updated, CreanovaAgentSettings):
