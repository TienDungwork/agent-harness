...
Thanks for your interest in contributing to Creanova! We're building the future of AI-powered software development, and we'd love for you to be part of this journey.

## Our Vision

The Creanova community is built around the belief that AI and AI agents are going to fundamentally change the way we build software. If this is true, we should do everything we can to make sure that the benefits provided by such powerful technology are accessible to everyone.
...
- **Use Creanova** and [report issues](https://github.com/Creanova/Creanova/issues) you encounter
- **Give feedback** using the thumbs-up/thumbs-down buttons after each session
- **Star our repository** on [GitHub](https://github.com/Creanova/Creanova)
- **Share Creanova** with other developers
...
- Browse [good first issues](https://github.com/Creanova/Creanova/labels/good%20first%20issue)
- Check our [project boards](https://github.com/Creanova/Creanova/projects) for organized tasks
- Join our [Slack community](https://Creanova.dev/joinslack) to ask what needs help

## Understanding the Codebase

- **[Frontend](./frontend/README.md)** - React application
- **[App Server (V1)](./Creanova/app_server/README.md)** - Current FastAPI application server and REST API modules
- **[Evaluation](https://github.com/Creanova/benchmarks)** - Testing and benchmarks
...
For bigger changes, join the #proj-gui channel in [Slack](https://Creanova.dev/joinslack) first.
...
Discuss major changes in [GitHub issues](https://github.com/Creanova/Creanova/issues) or [Slack](https://Creanova.dev/joinslack) first.

## Sending Pull Requests to Creanova

You'll need to fork our repository to send us a Pull Request. You can learn more
about how to fork a GitHub repo and open a PR with your changes in [this article](https://medium.com/swlh/forks-and-pull-requests-how-to-contribute-to-github-repos-8843fac34ce8).

You may also check out previous PRs in the [PR list](https://github.com/Creanova/Creanova/pulls).
...
- **Slack**: [Join our community](https://Creanova.dev/joinslack)
- **GitHub Issues**: [Open an issue](https://github.com/Creanova/Creanova/issues)
- **Email**: contact@Creanova.dev
