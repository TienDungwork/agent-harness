...
the get_impl() pattern used throughout Creanova. Enterprise deployments provide
...
from Creanova.analytics.user_base import UserBase
from Creanova.analytics.user_provider import AnalyticsUserProvider
