"""Creanova analytics package.

Provides a module-level singleton pattern for the AnalyticsService.

Usage::

    from Creanova.analytics import init_analytics_service, get_analytics_service
...
from Creanova.analytics.analytics_context import (
    AnalyticsContext,
    resolve_analytics_context,
)
from Creanova.analytics.analytics_service import AnalyticsService
