...
class CreanovaError(HTTPException):
    """General Error"""
...
class PermissionsError(CreanovaError):
...
class SandboxError(CreanovaError):
    """Error in Sandbox."""


class SandboxDeleteRetryError(CreanovaError):
