...
FastAPI-based application server that provides REST API endpoints for Creanova V1 integration.

## Overview

This package provides server and sandbox functionality to interact with the Creanova Software Agent SDK. It exposes REST API endpoints for managing conversations, sandboxes, events, and user settings.
