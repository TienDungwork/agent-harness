"""Secrets router for Creanova App Server.
...
from Creanova.app_server.secrets.secrets_models import (
    CustomSecretCreate,
    CustomSecretPage,
...
from Creanova.app_server.utils.models import EditResponse
...
async def search_custom_secrets(
    ...
    In SaaS mode, includes the system-generated Creanova_API_KEY which cannot be deleted.
