# Creanova FileStore Module

The file store module provides different storage backends for file operations in Creanova. This module implements a common interface (`FileStore`) that allows for interchangeable storage backends.
...
```python
from Creanova.app_server.file_store import get_file_store, LocalFileStore
...
To configure the file store in Creanova, use the following configuration options:
