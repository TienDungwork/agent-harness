"""Config router for Creanova App Server V1 API.
...
from Creanova.app_server.config import depends_llm_model_service
from Creanova.app_server.config_api.config_models import LLMModelPage, ProviderPage
...
async def search_providers(
    ...
    Each provider indicates whether it is verified by Creanova.
    """
