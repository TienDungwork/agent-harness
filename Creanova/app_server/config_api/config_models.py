"""Config-related models for Creanova App Server V1 API."""
...
class LLMModel(BaseModel):
    ...
    verified: bool = Field(
        default=False, description='Whether the model is verified by Creanova'
    )
    hidden: bool = Field(
        default=False,
        description=(
...
class Provider(BaseModel):
    ...
    verified: bool = Field(
        default=False, description='Whether the provider is verified by Creanova'
    )
