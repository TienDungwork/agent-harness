...
from Creanova.app_server.user_auth.user_auth import UserAuth, get_user_auth
from Creanova.sdk.secret import SecretSource, StaticSecret
...
class AuthUserContext(UserContext):
    ...
    async def get_user_id(self) -> str | None:
        ...
        # it means we are in Creanova (OSS mode).
    ...
    async def get_secrets(self) -> dict[str, SecretSource]:
        ...
        # Include custom secrets (includes Creanova_API_KEY in SaaS mode)
