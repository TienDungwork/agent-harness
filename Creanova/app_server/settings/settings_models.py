"""Settings models for Creanova App Server.

This module contains:
- Settings: Persisted settings for Creanova sessions
...
from Creanova.app_server.utils.jsonpatch_compat import deep_merge
from Creanova.sdk.mcp.config import MCPServer, dump_mcp_config
...
class MarketplaceRegistration(BaseModel):
    ...
    Wire-compatible with ``Creanova.sdk.marketplace.MarketplaceRegistration``
...
def _load_persisted_agent_settings(
    ...
    ``agent_kind: 'llm'`` tag to ``'Creanova'``, and validates against the
...
class Settings(BaseModel):
    """Persisted settings for Creanova sessions.
    ...
    def update(self, payload: dict[str, Any]) -> None:
        ...
        if isinstance(agent_update, dict):
            ...
            # config preservation tracked in Creanova/Creanova#14370.
    ...
    def agent_settings_serializer(
        self,
        agent_settings: CreanovaAgentSettings | ACPAgentSettings,
    ...
    def _normalize_inputs(cls, data: dict | object) -> dict | object:
        ...
        elif isinstance(agent_settings, (CreanovaAgentSettings, ACPAgentSettings)):
    ...
    def to_agent_settings(self) -> CreanovaAgentSettings | ACPAgentSettings:
