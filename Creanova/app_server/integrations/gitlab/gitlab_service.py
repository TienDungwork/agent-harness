...
from Creanova.app_server.integrations.gitlab.service import (
    GitLabBranchesMixin,
    GitLabFeaturesMixin,
    GitLabPRsMixin,
    GitLabReposMixin,
...
class GitLabService(
    ...
    This is an extension point in Creanova that allows applications to customize GitLab
...
gitlab_service_cls = os.environ.get(
    'Creanova_GITLAB_SERVICE_CLS',
    'Creanova.app_server.integrations.gitlab.gitlab_service.GitLabService',
)
