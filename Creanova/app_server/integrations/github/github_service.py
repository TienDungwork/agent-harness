...
from Creanova.app_server.integrations.github.service import (
    GitHubBranchesMixin,
    GitHubFeaturesMixin,
    GitHubPRsMixin,
    GitHubReposMixin,
...
class GitHubService(
    ...
    This is an extension point in Creanova that allows applications to customize GitHub
...
github_service_cls = os.environ.get(
    'Creanova_GITHUB_SERVICE_CLS',
    'Creanova.app_server.integrations.github.github_service.GitHubService',
)
