...
from Creanova.app_server.integrations.bitbucket.service import (
...
class BitBucketService(
    ...
    This is an extension point in Creanova that allows applications to customize Bitbucket
...
bitbucket_service_cls = os.environ.get(
    'Creanova_BITBUCKET_SERVICE_CLS',
    'Creanova.app_server.integrations.bitbucket.bitbucket_service.BitBucketService',
)
