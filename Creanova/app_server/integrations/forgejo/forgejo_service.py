...
from Creanova.app_server.integrations.forgejo.service import (
...
forgejo_service_cls = os.environ.get(
    'Creanova_FORGEJO_SERVICE_CLS',
    'Creanova.app_server.integrations.forgejo.forgejo_service.ForgejoService',
)
