...
from Creanova.app_server.integrations.bitbucket_data_center.service import (
...
class BitbucketDCService(
    ...
    This is an extension point in Creanova that allows applications to customize Bitbucket data center
...
bitbucket_dc_service_cls = os.environ.get(
    'Creanova_BITBUCKET_DATA_CENTER_SERVICE_CLS',
    'Creanova.app_server.integrations.bitbucket_data_center.bitbucket_dc_service.BitbucketDCService',
)
