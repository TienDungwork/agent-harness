...
from Creanova.agent_server.env_parser import DiscriminatedUnionMixin
...
from Creanova.app_server.web_client.web_client_deployment_mode import (
    DeploymentMode,
    get_deployment_mode,
)
...
class WebClientConfig(DiscriminatedUnionMixin):
    ...
    # Optional Creanova Enterprise/KOTS-managed Jira DC service account. When
