"""Event Callback router for Creanova App Server."""
...
from Creanova import tools  # type: ignore[attr-defined]
from Creanova.agent_server.models import ConversationInfo, Success
from Creanova.analytics import get_analytics_service, resolve_analytics_context
from Creanova.app_server import shared
...
from Creanova.app_server.errors import AuthError
...
from Creanova.app_server.event_callback.event_callback_result_models import (
...
from Creanova.app_server.integrations.provider import ProviderType
from Creanova.app_server.sandbox.sandbox_models import SandboxRecord
...
from Creanova.app_server.user.auth_user_context import AuthUserContext
from Creanova.app_server.user.specifiy_user_context import (
    ADMIN,
    USER_CONTEXT_ATTR,
    SpecifyUserContext,
)
from Creanova.app_server.user_auth.default_user_auth import DefaultUserAuth
from Creanova.app_server.user_auth.user_auth import (
    get_for_user as get_user_auth_for_user,
)
from Creanova.sdk import ConversationExecutionStatus, Event
from Creanova.sdk.event import ConversationStateUpdateEvent, ObservationEvent
from Creanova.sdk.settings import ACPAgentSettings
from Creanova.sdk.settings.acp_providers import detect_acp_provider_by_command
from Creanova.sdk.tool.builtins import SwitchLLMObservation
...
async def on_conversation_update(
    ...
    union so both Creanova (``Agent``) and ACP (``ACPAgent``) payloads are
