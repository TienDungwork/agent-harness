# TODO: Merge this module with Creanova.app_server.config
import os

from Creanova.app_server.types import AppMode, ServerConfigInterface
...
class ServerConfig(ServerConfigInterface):
    config_cls = os.environ.get('Creanova_CONFIG_CLS', None)
    ...
    settings_store_class: str = (
        'Creanova.app_server.settings.file_settings_store.FileSettingsStore'
    )
    secret_store_class: str = (
        'Creanova.app_server.secrets.file_secrets_store.FileSecretsStore'
    )
    user_auth_class: str = (
        'Creanova.app_server.user_auth.default_user_auth.DefaultUserAuth'
    )
