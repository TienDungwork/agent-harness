"""Sandboxed Conversation router for Creanova App Server."""
...
from Creanova.agent_server.models import Success
from Creanova.analytics import get_analytics_service, resolve_analytics_context
...
from Creanova.app_server.sandbox.sandbox_spec_service import SandboxSpecService
from Creanova.app_server.services.db_session_injector import set_db_session_keep_open
from Creanova.app_server.services.httpx_client_injector import (
...
from Creanova.app_server.settings.settings_models import Settings
from Creanova.app_server.settings.settings_router import LITE_LLM_API_URL
from Creanova.app_server.user.specifiy_user_context import USER_CONTEXT_ATTR
from Creanova.app_server.user.user_context import UserContext
from Creanova.app_server.user_auth import get_user_settings
from Creanova.app_server.utils.dependencies import get_dependencies
from Creanova.app_server.utils.docker_utils import (
    replace_localhost_hostname_for_docker,
)
from Creanova.sdk.skills import KeywordTrigger, TaskTrigger
...
async def _get_agent_server_context(
    ...
    if not sandbox_spec:
        ...
        # sandbox spec versions when updating Creanova. When the SandboxSpecServices
...
async def get_conversation_skills(
    ...
    - Global skills (Creanova/skills/)
    - User skills (~/.Creanova/skills/)
    - Organization skills (org/.Creanova repository)
    - Repository skills (repo .agents/skills/, .Creanova/microagents/, and legacy .Creanova/skills/)
...
async def get_conversation_hooks(
    ...
    workspace (i.e. `{project_dir}/.Creanova/hooks.json`) at request time.

    Note:
        This is intentionally a "live" view of the workspace configuration.
        If `.Creanova/hooks.json` changes over time, this endpoint reflects the
    ...
    try:
        ...
        try:
            ...
            if analytics and user_id:
                from Creanova.analytics.analytics_context import AnalyticsContext
