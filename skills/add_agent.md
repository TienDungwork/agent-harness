...
This agent helps create new microagents in the `.Creanova/microagents` directory by providing guidance and templates.
...
- Create a markdown file in `.Creanova/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
...
- [Microagents Overview](https://docs.Creanova.dev/usage/prompting/microagents-overview)
- [Example GitHub Skill](https://github.com/Creanova/Creanova/blob/main/skills/github.md)
