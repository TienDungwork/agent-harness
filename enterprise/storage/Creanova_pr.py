...
class CreanovaPR(Base):
    """
    Represents a pull request created by Creanova.
    """

    __tablename__ = 'Creanova_prs'
    ...
    Creanova_helped_author: Mapped[bool | None] = mapped_column(nullable=True)
    num_Creanova_commits: Mapped[int | None] = mapped_column(nullable=True)
    num_Creanova_review_comments: Mapped[int | None] = mapped_column(nullable=True)
    num_Creanova_general_comments: Mapped[int | None] = mapped_column(nullable=True)
