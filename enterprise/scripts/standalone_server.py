...
DEFAULT_DB_URL = 'postgresql://postgres:postgres@localhost:5432/Creanova'
DEFAULT_PORT = 8080
...
# Create FastAPI app
app = FastAPI(title='Creanova Admin API', version='1.0.0')
...
@app.get('/')
async def root():
    return {'message': 'Creanova Admin API', 'docs': '/docs'}
...
<head>
    ...
    <title>Creanova Admin Dashboard</title>
    <style>
...
<body>
    <div class="container">
        <header>
            <h1>🎯 Creanova Admin Dashboard</h1>
