...
if not os.getenv('Creanova_CONFIG_CLS'):
    os.environ['Creanova_CONFIG_CLS'] = 'server.config.SaaSServerConfig'
...
from Creanova.app_server.app import app as base_app  # noqa: E402
from Creanova.app_server.middleware import (  # noqa: E402
    CacheControlMiddleware,
)
from Creanova.app_server.static import SPAStaticFiles  # noqa: E402
