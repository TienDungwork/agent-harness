...
Tests the FastAPI dependency that validates @Creanova.dev email domain.
"""
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_success(mock_request, mock_user_auth):
    """
    GIVEN: Valid user ID and @Creanova.dev email
    WHEN: get_admin_user_id is called
    THEN: User ID is returned successfully
    """
    # Arrange
    user_id = 'test-user-123'
    mock_user_auth.get_user_email.return_value = 'test@Creanova.dev'
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_no_user_id(mock_request):
    """
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_no_email(mock_request, mock_user_auth):
    """
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_invalid_domain(mock_request, mock_user_auth):
    """
    GIVEN: User ID and email with non-@Creanova.dev domain
    WHEN: get_admin_user_id is called
    ...
    with patch('server.email_validation.get_user_auth', return_value=mock_user_auth):
        ...
        assert 'Creanova.dev' in exc_info.value.detail.lower()


@pytest.mark.asyncio
async def test_get_Creanova_user_id_empty_string_user_id(mock_request):
    """
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_case_sensitivity(mock_request, mock_user_auth):
    """
    GIVEN: Email with uppercase @Creanova.DEV domain
    WHEN: get_admin_user_id is called
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_subdomain_not_allowed(
    mock_request, mock_user_auth
):
    """
    GIVEN: Email with subdomain like @test.Creanova.dev
    WHEN: get_admin_user_id is called
    THEN: 403 Forbidden is raised
    """
    # Arrange
    user_id = 'test-user-123'
    mock_user_auth.get_user_email.return_value = 'test@test.Creanova.dev'
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_similar_domain_not_allowed(
    mock_request, mock_user_auth
):
    """
    GIVEN: Email with similar but different domain like @Creanova.dev.fake.com
    WHEN: get_admin_user_id is called
    THEN: 403 Forbidden is raised
    """
    # Arrange
    user_id = 'test-user-123'
    mock_user_auth.get_user_email.return_value = 'test@Creanova.dev.fake.com'
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_logs_warning_on_invalid_domain(
    mock_request, mock_user_auth
):
    """
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_with_plus_addressing(mock_request, mock_user_auth):
    """
    GIVEN: Email with plus addressing (test+tag@Creanova.dev)
    WHEN: get_admin_user_id is called
    THEN: User ID is returned successfully
    """
    # Arrange
    user_id = 'test-user-123'
    mock_user_auth.get_user_email.return_value = 'test+tag@Creanova.dev'
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_with_dots_in_local_part(
    mock_request, mock_user_auth
):
    """
    GIVEN: Email with dots in local part (first.last@Creanova.dev)
    WHEN: get_admin_user_id is called
    THEN: User ID is returned successfully
    """
    # Arrange
    user_id = 'test-user-123'
    mock_user_auth.get_user_email.return_value = 'first.last@Creanova.dev'
...
@pytest.mark.asyncio
async def test_get_Creanova_user_id_empty_email(mock_request, mock_user_auth):
    """
...
async def test_get_org_creator_user_id_feature_disabled_admin_email_succeeds(
    ...
    """
    GIVEN: OPEN_ORG_CREATION_ENABLED is disabled and user has @Creanova.dev email
    WHEN: get_org_creator_user_id is called
