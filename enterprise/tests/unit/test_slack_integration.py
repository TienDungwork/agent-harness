...
def slack_new_conversation_view(mock_slack_user, mock_user_auth):
    ...
    return SlackNewConversationView(
        ...
        user_msg='Hello Creanova!',
        slack_user_id='U1234567890',
        slack_to_Creanova_user=mock_slack_user,
...
class TestRepoVerificationHandling:
    ...
    async def test_timeout_during_verification_shows_selector(
        ...
        slack_new_conversation_view.user_msg = 'Help me with Creanova/Creanova repo'
    ...
    async def test_verified_repo_starts_job(
        ...
        assert slack_new_conversation_view.selected_repo == 'Creanova/Creanova'
...
class TestUserMsgStorage:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                '1234567890.123456',
                '1234567890.111111',
                'Hello Creanova, help me with my code',
            ),
            ('1234567890.123456', None, 'Hello Creanova'),
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                b'Hello Creanova, help me with my code',
                'Hello Creanova, help me with my code',
            ),
            ('Hello Creanova', 'Hello Creanova'),  # String instead of bytes
        ],
