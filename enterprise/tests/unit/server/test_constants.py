...
class TestDeploymentMode:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('app.Creanova.ai', 'cloud'),
            # Creanova.dev is also an All-Hands managed domain
            ('app.Creanova.dev', 'cloud'),
            ('staging.Creanova.dev', 'cloud'),
            ('pr-456.staging.Creanova.dev', 'cloud'),
            # Customer domains should return 'self_hosted'
            ('Creanova.acme.com', 'self_hosted'),
            ('internal.company.io', 'self_hosted'),
            ('dev.mycompany.net', 'self_hosted'),
            ('Creanova.example.org', 'self_hosted'),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('app.Creanova.ai', True),
            ('app.Creanova.dev', True),
            ('staging.Creanova.dev', True),
            ('pr-1.staging.Creanova.dev', True),
            ('localhost', False),  # localhost is not a managed domain
            ('customer.example.com', False),
            ('all-hands.dev', False),
            ('Creanova.dev', False),  # apex is not a subdomain, so not managed
        ],
    )
...
class TestStagingAndFeatureEnvDetection:
    ...
    all-hands.dev and the new Creanova.dev staging/feature hosts."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('app.Creanova.dev', False, False),
            ('Creanova.acme.com', False, False),
