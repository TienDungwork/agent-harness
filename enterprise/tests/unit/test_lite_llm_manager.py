...
class TestVerifyExistingKey:
    ...
    @pytest.mark.asyncio
    async def test_verify_existing_key_Creanova_type_found(self):
        """Test _verify_existing_key finds matching Creanova key."""
        mock_keys = [
            {
                'key_name': 'sk-test1234',
    ...
    @pytest.mark.asyncio
    async def test_verify_existing_key_Creanova_type_not_found(self):
    ...
    @pytest.mark.asyncio
    async def test_verify_existing_key_by_alias_Creanova_cloud(self):
        """Test _verify_existing_key finds key by Creanova Cloud alias."""
        user_id = 'test-user-id'
        org_id = 'test-org'
        mock_keys = [
            {
                'key_name': 'sk-testABCD',
                'key_alias': get_Creanova_cloud_key_alias(user_id, org_id),
                'team_id': org_id,
                'metadata': None,
            }
        ]
