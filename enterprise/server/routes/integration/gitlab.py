...
async def gitlab_events(
    ...
    x_Creanova_webhook_id: str = Header(None),
    x_Creanova_user_id: str = Header(None),
):
    try:
        await verify_gitlab_signature(
            header_webhook_secret=x_gitlab_token,
            webhook_uuid=x_Creanova_webhook_id,
            user_id=x_Creanova_user_id,
        )
        ...
        message = Message(
            ...
            message={
                ...
                'installation_id': x_Creanova_webhook_id,
            },
        )
