...
def setup_all_loggers():
    ...
    Leave Creanova alone since it's already configured.
    """
    if LOG_JSON:
...
setup_all_loggers()
# Creanova logger is heavily customized - so we want to make sure that it is logging json
setup_json_logger(Creanova_logger)
