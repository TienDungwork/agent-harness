...
from Creanova.agent_server.models import EventPage, EventSortOrder
from Creanova.app_server.config import get_global_config
from Creanova.app_server.event.event_service import EventService
from Creanova.app_server.event.filesystem_event_service import FilesystemEventService
from Creanova.app_server.event_callback.event_callback_models import EventKind
...
class FilesystemSharedEventServiceInjector(SharedEventServiceInjector):
    async def inject(
        ...
        from Creanova.app_server.config import get_db_session
