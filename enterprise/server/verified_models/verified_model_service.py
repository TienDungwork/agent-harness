...
from Creanova.app_server.services.db_session import depends_db_session
...
class VerifiedModelService:
    ...
    async def search_verified_models(
        ...
        Args:
            provider: Optional provider name to filter by (e.g., 'Creanova', 'anthropic')
