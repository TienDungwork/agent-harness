"""Resolve which Creanova organization workspace a resolver conversation should be created in.

This module provides a reusable utility for routing resolver conversations
(GitHub, GitLab, Bitbucket, Slack, etc.) to the correct Creanova organization
...
async def resolve_org_for_repo(
    ...
    """Determine the Creanova org_id for a resolver conversation.

    If the repo's git organization is claimed by an Creanova org, returns the
    ...
    Args:
        ...
        full_repo_name: Full repository name (e.g., "Creanova/foo")
