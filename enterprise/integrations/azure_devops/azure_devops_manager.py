...
class AzureDevOpsManager(Manager[AzureDevOpsViewType]):
    def __init__(self, token_manager: TokenManager, data_collector: None = None):
        ...
        self.jinja_env = Environment(
            loader=FileSystemLoader(Creanova_RESOLVER_TEMPLATES_DIR + 'azure_devops')
        )
    ...
    async def receive_message(self, message: Message) -> None:
        ...
        if not keycloak_user_id:
            logger.info(
                ...
                'has no Creanova account; ignoring event.'
            )
            return
    ...
    async def send_message(
        ...
        message = mark_Creanova_comment(message)
        ...
        try:
            try:
                ...
                msg_info = (
                    ...
                    f'[Creanova Cloud]({HOST_URL}) before starting a job.'
                )
                ...
                msg_info = (
                    ...
                    f'in [Creanova Cloud]({HOST_URL}) before starting a job.'
                )
