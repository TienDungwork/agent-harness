...
class JiraPayloadParser:
    ...
    def __init__(self, oh_label: str, inline_oh_label: str):
        """Initialize parser with Creanova label configuration.

        Args:
            oh_label: Label that triggers Creanova (e.g., 'Creanova')
            inline_oh_label: Mention that triggers Creanova (e.g., '@Creanova')
        """
    ...
    def _has_mention(self, text: str) -> bool:
        """Check if text contains an exact mention of Creanova."""
