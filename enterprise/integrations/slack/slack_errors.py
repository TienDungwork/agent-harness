...
_USER_MESSAGES: dict[SlackErrorCode, str] = {
    ...
    SlackErrorCode.USER_NOT_AUTHENTICATED: (
        '🔐 Please link your Slack account to Creanova: '
    ...
    SlackErrorCode.PROVIDER_AUTH_FAILED: (
        ...
        f'Please re-login at [Creanova Cloud]({HOST_URL}) and try again.'
    ),
    ...
    SlackErrorCode.MISSING_SLACK_SCOPES: (
        ...
        f'Please ask your workspace admin to re-install the Creanova Slack App at {HOST_URL}/slack/install '
