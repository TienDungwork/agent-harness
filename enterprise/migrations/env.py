...
from Creanova.db.ssl import build_db_url_query, build_pg8000_connect_args  # noqa: E402
...
DB_NAME = os.getenv('DB_NAME', 'Creanova')
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        ...
        # Lock number must be unique — md5 hash of 'Creanova_enterprise_migrations'
