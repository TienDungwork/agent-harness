...
This document traces the complete data flow for launching plugins in Creanova, from the source marketplace through to agent execution. Each section shows the exact endpoints, payloads, and transformations.
...
**Source**: A GitHub repository (e.g., `github.com/Creanova/plugin-marketplace`)
...
```json
{
  "name": "Creanova Plugin Marketplace",
  "owner": {
    "name": "Creanova",
    "email": "team@all-hands.dev"
  },
  "metadata": {
    "description": "Official Creanova plugin marketplace",
    "pluginRoot": "plugins"
  },
  "plugins": [
    {
      "name": "city-weather",
      "source": "github:jpshackelford/Creanova-sample-plugins",
      "ref": "main",
  ...
  "plugins": [
    {
      ...
      "source": {
        "source": "github",
        "repo": "jpshackelford/Creanova-sample-plugins",
        "ref": "main",
        "repo_path": "plugins/city-weather"
      },
      "tags": ["weather", "utility"]
...
**Launch URL**:
```
https://app.Creanova.ai/launch?plugins=BASE64&message=%2Fcity-weather%3Anow
```
...
## Step 4: Creanova Frontend (`/launch` Route)

**Route**: `/launch?plugins=BASE64&message=/city-weather:now`

[PR #12699](https://github.com/Creanova/Creanova/pull/12699)
...
## Step 5: Creanova App Server

**Endpoint**: `POST /api/v1/app-conversations`

[PR #12338](https://github.com/Creanova/Creanova/pull/12338)
...
2. **Convert PluginSpec → SDK PluginSource** (parameters are DROPPED):
   ...
   sdk_plugins = [
       PluginSource(
           source=p.source,      # "github:jpshackelford/Creanova-sample-plugins"
           ref=p.ref,            # "main"
...
[SDK PR #1651](https://github.com/Creanova/software-agent-sdk/pull/1651)
...
[SDK PR #1647](https://github.com/Creanova/software-agent-sdk/pull/1647)
...
| 4 | Creanova Frontend | URL query params | API call: `plugins` (with user values) + `message` (unchanged slash command) |
...
```
┌─────────────────────┐     ┌─────────────────────┐     ┌─────────────────────┐
│  Plugin Directory   │     │  Creanova Frontend │     │    App Server       │
│                     │     │                     │     │                     │
...
- [Creanova PR #12338](https://github.com/Creanova/Creanova/pull/12338) - App server plugin support
- [Creanova PR #12699](https://github.com/Creanova/Creanova/pull/12699) - Frontend `/launch` route
- [SDK PR #1651](https://github.com/Creanova/software-agent-sdk/pull/1651) - Agent server plugin loading
- [SDK PR #1647](https://github.com/Creanova/software-agent-sdk/pull/1647) - Plugin.fetch() for remote plugin fetching
- [SDK PR #2230](https://github.com/Creanova/software-agent-sdk/pull/2230) - entry_command field definition
- [Plugin Directory PR #84](https://github.com/Creanova/plugin-directory/pull/84) - entry_command support in plugin directory
