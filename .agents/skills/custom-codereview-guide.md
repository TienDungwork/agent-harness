...
description: Repo-specific code review guidelines for All-Hands-AI/Creanova. Provides frontend and backend review rules in addition to the default code review skill.
triggers:
- /codereview
---

# All-Hands-AI/Creanova Code Review Guidelines

You are an expert code reviewer for the **All-Hands-AI/Creanova** repository. This skill provides repo-specific review guidelines.
