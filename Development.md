...
This guide is for people working on Creanova and editing the source code.
If you wish to contribute your changes, check out the
[CONTRIBUTING.md](https://github.com/Creanova/Creanova/blob/main/CONTRIBUTING.md)
on how to clone and setup the project initially before moving on. Otherwise,
you can clone the Creanova project directly.
...
Creanova supports a diverse array of Language Models (LMs) through the powerful [litellm](https://docs.litellm.ai) library.

For the V1 web app, start Creanova and configure your model and API key in the Settings UI.
...
See [our documentation](https://docs.Creanova.dev/Creanova/usage/llms/llms) for recommended models.
...
These targets serve the current Creanova V1 API by default. In the codebase, `make start-backend` runs `Creanova.server.listen:app`, and that app includes the `Creanova/app_server` V1 routes unless `ENABLE_V1=0`.
...
**Important:** Keep your project files in the WSL filesystem (e.g., `~/workspace/Creanova`), not in `/mnt/c`. Files accessed via `/mnt/c` will be significantly slower.
...
If you just want to run Creanova without setting up a dev environment:
...
You can use Creanova to develop and improve Creanova itself!
...
- [/Development.md](./Development.md) (this file): Comprehensive guide for developers working on Creanova
- [/CONTRIBUTING.md](./CONTRIBUTING.md): Guidelines for contributing to the project, including code style and PR process
- [DOC_STYLE_GUIDE.md](https://github.com/Creanova/docs/blob/main/Creanova/DOC_STYLE_GUIDE.md): Standards for writing and maintaining project documentation
- [/Creanova/app_server/README.md](./Creanova/app_server/README.md): Current V1 application server implementation and REST API modules
- [/frontend/README.md](./frontend/README.md): Frontend React application setup and development guide
- [/containers/README.md](./containers/README.md): Information about Docker containers and deployment
- [/tests/unit/README.md](./tests/unit/README.md): Guide to writing and running unit tests
- [Creanova/benchmarks](https://github.com/Creanova/benchmarks): Documentation for the evaluation framework and benchmarks
