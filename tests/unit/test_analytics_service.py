...
from Creanova.analytics import (
    AnalyticsService,
    get_analytics_service,
    init_analytics_service,
)
from Creanova.analytics.analytics_constants import (
...
from Creanova.analytics.analytics_service import AnalyticsService as DirectService
from Creanova.analytics.oss_install_id import get_or_create_install_id
from Creanova.server.types import AppMode
...
def reset_singleton():
    ...
    import Creanova.analytics as analytics_module
...
def mock_posthog():
    ...
    with patch(
        'Creanova.analytics.analytics_service.Posthog', autospec=True
    ) as MockClass:
