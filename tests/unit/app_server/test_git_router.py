...
from Creanova.app_server.git.git_models import SortOrder
from Creanova.app_server.git.git_router import (
    router,
    search_branches,
    search_repositories,
...
class TestInstallationsEndpoint:
    ...
    def test_returns_403_when_no_provider_tokens(self, test_client):
        ...
        with patch(
            'Creanova.app_server.user.auth_user_context.AuthUserContext.get_provider_tokens',
...
class TestSearchUserInstallations:
    ...
    @pytest.mark.asyncio
    @patch('Creanova.app_server.git.git_router.ProviderHandler')
