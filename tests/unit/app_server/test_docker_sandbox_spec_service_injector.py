...
from Creanova.app_server.sandbox.preset_sandbox_spec_service import (
...
class TestDockerSandboxSpecServiceInjector:
    ...
    @patch('Creanova.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    ...
    def test_get_default_sandbox_specs(self):
        ...
        assert specs[0].id.startswith('ghcr.io/Creanova/agent-server:')
    ...
    @patch(
        'Creanova.app_server.sandbox.docker_sandbox_spec_service._global_docker_client',
        None,
    )
    ...
    def test_get_docker_client_reuses_existing_client(
        ...
        import Creanova.app_server.sandbox.docker_sandbox_spec_service as module
    ...
    @patch('Creanova.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    @patch('Creanova.app_server.sandbox.docker_sandbox_spec_service._logger')
