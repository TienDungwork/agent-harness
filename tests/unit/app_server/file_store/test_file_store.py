...
from Creanova.app_server.file_store.google_cloud import GoogleCloudFileStore
...
from Creanova.app_server.file_store.s3 import S3FileStore
...
class TestLocalFileStore(TestCase, _StorageTest):
    def setUp(self):
        ...
        self.temp_dir = tempfile.mkdtemp(prefix='Creanova_test_')
...
@patch(
    'Creanova.app_server.file_store.google_cloud.storage.Client',
