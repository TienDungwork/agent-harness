...
from Creanova.sdk import Message, MessageEvent, TextContent
...
async def test_set_title_callback_processor_fetches_title_from_conversation():
    ...
    with (
        patch(
            'Creanova.app_server.config.get_app_conversation_service',
        ...
        patch('Creanova.app_server.config.get_httpx_client', get_httpx_client),
        patch(
            'Creanova.app_server.event_callback.'
