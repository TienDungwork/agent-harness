...
from Creanova.app_server.config_api.llm_model_service import LLMModelService
...
class TestToLLMModelsHiddenCanonical:
    ...
    def test_canonical_set_only_on_mapped_hidden_models(self):
        response = ModelsResponse(
            models=['Creanova/real-model'],
            verified_models=['real-model'],
            verified_providers=['Creanova'],
            default_model='Creanova/real-model',
            hidden_models=['Creanova/legacy-alias', 'Creanova/untagged-alias'],
            hidden_model_canonicals={'Creanova/legacy-alias': 'Creanova/real-model'},
        )
