...
def test_sensitive_filter_applied_to_handler_catches_child_logger_records():
    ...
    the handler as well as to Creanova_logger so that child-logger records
    (e.g. Creanova.app_server.*) are still redacted.
    """
    import io
    ...
    parent = logging.getLogger('Creanova.test_parent')
    parent.addHandler(handler)
    parent.setLevel(logging.DEBUG)
    parent.propagate = False

    child = logging.getLogger('Creanova.test_parent.child')
