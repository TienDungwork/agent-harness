...
from Creanova.app_server.integrations.github.github_service import GitHubService
        ...
        'items': [
            {
                'id': 1,
                'name': 'Creanova',
                'full_name': 'All-Hands-AI/Creanova',
                'private': False,
                'html_url': 'https://github.com/All-Hands-AI/Creanova',
                'clone_url': 'https://github.com/All-Hands-AI/Creanova.git',
...
async def test_resolve_primary_email_selects_primary_verified():
    ...
    from Creanova.app_server.integrations.github.service.base import GitHubMixinBase
