# The Creanova Community

Creanova is a community of engineers, academics, and enthusiasts reimagining software development for an AI-powered
world.
...
Everyone should feel empowered to contribute to Creanova. Whether it’s by making a PR, hosting an event, sharing
feedback, or just asking a question, don’t hold back!

Creanova gives everyone the building blocks to create state-of-the-art developer experiences. We experiment constantly
...
Creanova is supported by the for-profit organization [All Hands AI, Inc](https://www.Creanova.dev/).

All Hands was founded by three of the first major contributors to Creanova:

- Xingyao Wang, a UIUC PhD candidate who got Creanova to the top of the SWE-bench leaderboards
- Graham Neubig, a CMU Professor who rallied the academic community around Creanova
- Robert Brennan, a software engineer who architected the user-facing features of Creanova

All Hands is an important part of the Creanova ecosystem. We’ve raised over $20M--mainly to hire developers and
researchers who can work on Creanova full-time, and to provide them with expensive infrastructure. ([Join us!](https://allhandsai.applytojob.com/apply/))

But we see Creanova as much larger, and ultimately more important, than All Hands. When our financial responsibility
...
At some point, we may transfer custody of Creanova to an open source foundation. But for now,
